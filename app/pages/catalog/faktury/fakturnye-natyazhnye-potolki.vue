  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Фактурные натяжные потолки в&nbsp;Иркутске
          </h1>
          <p class="cp-hero__price">
            Акция: <span>3-й потолок в подарок!</span> Гарантия 12 лет.<br>
            Уникальный дизайн. Монтаж за 1 день. Без предоплаты.
          </p>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Фактурные натяжные потолки — имитация кожи, мрамора, камня</h2>
            <div class="cp-text" itemprop="description">
              <p>Фактурный потолок — это возможность создать уникальный интерьер. Поверхность полотна имитирует кожу, мрамор, замшу, камень или металлик. Тиснение наносится на заводе — покрытие выглядит стильно и дорого.</p>
              <p>Освещение играет ключевую роль: рельефный узор раскрывается в направленном свете. Рекомендуем точечные светильники или трековые системы — так фактура будет максимально выразительной.</p>

              <h3>Что мы предлагаем</h3>
              <p>Реализуем фактурные полотна с имитацией кожи, мрамора, камня, текстиля и металлика. Полотна можно комбинировать — спаивать по диагонали или в многоуровневой конструкции.</p>

              <h3>Преимущества фактурных натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Фактурные потолки идеальны для гостиных, кабинетов, ресторанов и бутиков — везде, где важна атмосфера и уникальный стиль. Важно: планируйте дополнительное освещение для раскрытия фактуры.</p>
            </div>
          </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость фактурного потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фотографии фактурных натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на фактурные потолки</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про фактурные натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Фактурные натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает фактурные натяжные потолки в Иркутске с 2009 года. Имитация кожи, мрамора, камня — монтируем без предоплаты, даём письменную гарантию 12 лет.</p>
            <h3>Особенности фактурных потолков</h3>
            <p>Рельефное тиснение раскрывается при направленном боковом освещении. Рекомендуем точечные или трековые светильники — так фактура выглядит наиболее выразительно и дорого.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Устанавливаем фактурные потолки по всему Иркутску. Замер бесплатный. Монтаж — 2–4 часа. Оплата после приёмки. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите фактурный натяжной потолок?</h2>
...
const gallery = catalogGallery['fakturnye-natyazhnye-potolki'] ?? []
