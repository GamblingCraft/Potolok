      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <p class="cp-hero__price">
            ...
            Уникальный дизайн. Монтаж за 1 день. Оплата после приёмки.
          </p>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает фактурные натяжные потолки в Иркутске с 2009 года. Имитация кожи, мрамора, камня — оплата после приёмки, даём письменную гарантию 12 лет.</p>
...
const _content = await usePageContent('fakturnye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('fakturnye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('fakturnye-natyazhnye-potolki'))
const _prices = await useCatalogPrices()
const price = computed(() => _prices.value?.['fakturnye'] ?? item.price)

const item = faktury.find(f => f.id === 'fakt')!
const heroImg = usePageHero('fakturnye-natyazhnye-potolki', item.img)
