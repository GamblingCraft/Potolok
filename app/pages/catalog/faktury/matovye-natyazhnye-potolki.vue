  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Матовые натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          ...
          <div class="cp-main">
            <h2 class="cp-h2">Матовые натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Матовый натяжной потолок — самый популярный выбор. Поверхность мягко рассеивает свет, визуально напоминает финишную штукатурку без единого изъяна. Никаких бликов, никаких отражений — только ровный, спокойный вид.</p>
              <p>Изготавливается из ПВХ-плёнки с матовой поверхностью. Не отражает предметы, равномерно распределяет свет по всему помещению — идеально для комнат с несколькими источниками освещения.</p>

              <h3>Что мы предлагаем</h3>
              <p>Поставляем матовые полотна ведущих брендов: <strong>MSD, Bauf (Германия), Teqtum</strong>. В каталоге — 100+ цветов и оттенков. Ширина полотна до 5 метров — бесшовный монтаж в большинстве помещений.</p>

              <h3>Преимущества матовых натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <p>Матовый потолок белого цвета — неувядающая классика. Отлично подходит для спальни, детской, гостиной, кухни и прихожей. Совместим с любыми технологиями освещения и конструкциями.</p>
            </div>
          </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость матового потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фотографии матовых натяжных потолков</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про матовые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Матовые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает матовые натяжные потолки в Иркутске с 2009 года. Работаем с европейскими материалами, монтируем без предоплаты, даём письменную гарантию 12 лет.</p>
            <h3>Особенности матовых потолков</h3>
            <p>Матовая поверхность не имеет отражательной способности — свет рассеивается равномерно. Это делает освещение мягким и комфортным, скрывает визуальные дефекты помещения.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Устанавливаем матовые потолки по всему Иркутску. Замер бесплатный. Монтаж комнаты — 2–4 часа. Оплата после приёмки. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите матовый натяжной потолок?</h2>
