  ...
  <div>
    <section class="cl-hero">
      <div class="container cl-hero__inner">
        <div>
          ...
          <h1 class="cl-hero__title">Натяжные потолки по фактуре</h1>
          <p class="cl-hero__desc">Матовые, глянцевые, сатиновые, тканевые и фактурные полотна — выберите поверхность под любой интерьер и бюджет</p>
        ...
        <div class="cl-hero__badge">
          <div class="cl-hero__badge-val">{{ faktury.length }}</div>
          <div class="cl-hero__badge-label">вида фактур</div>
        </div>
      </div>
    </section>
    ...
    <section class="cl-section">
      <div class="container">
        ...
        <div class="cl-cta">
          <div>
            <div class="cl-cta__title">Не знаете какую фактуру выбрать?</div>
            <div class="cl-cta__desc">Замерщик привезёт образцы всех фактур и поможет выбрать прямо у вас дома — бесплатно</div>
          </div>
        ...
        <div class="cl-seo">
          ...
          <p><strong>Матовые</strong> — самый популярный вариант. Равномерно рассеивают свет, скрывают неровности, подходят для любых помещений. От 159 ₽/м².</p>
          <p><strong>Глянцевые</strong> — зеркальный эффект визуально увеличивает пространство. Идеальны для гостиных и спален с точечным освещением. От 209 ₽/м².</p>
          <p><strong>Сатиновые</strong> — мягкий шёлковый блеск. Сочетают плюсы матового и глянцевого. Универсальный выбор. От 189 ₽/м².</p>
          <p><strong>Тканевые</strong> — немецкое полотно без ПВХ. Гипоаллергенны, рекомендованы для детских и спален. От 319 ₽/м².</p>
        </div>
      </div>
    </section>
