      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <p class="cp-hero__price">
            ...
            Без токсинов. Для детей и аллергиков. Оплата после приёмки.
          </p>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает гипоаллергенные натяжные потолки в Иркутске с 2009 года. Clipso, Descor, Teqtum — оплата после приёмки, даём письменную гарантию 12 лет.</p>
