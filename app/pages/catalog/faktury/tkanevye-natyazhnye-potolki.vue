  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Тканевые натяжные потолки в&nbsp;Иркутске
          </h1>
          <p class="cp-hero__price">
            Акция: <span>3-й потолок в подарок!</span> Гарантия 12 лет.<br>
            Без ПВХ. Монтаж без нагрева. Оплата после приёмки.
          </p>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Тканевые натяжные потолки — без ПВХ, без нагрева, безопасно</h2>
            <div class="cp-text" itemprop="description">
              <p>Тканевые натяжные потолки изготавливаются из полиэстера — без ПВХ. Монтируются без нагрева тепловой пушкой: холодная технология означает, что нет ни запаха, ни токсичных испарений. Въезжать можно сразу.</p>
              <p>Главное преимущество — ширина полотна до 5.2 метра. Это позволяет перекрывать большинство помещений без единого шва. Антистатическое покрытие не притягивает пыль, долго остаётся чистым.</p>

              <h3>Что мы предлагаем</h3>
              <p>Работаем с тканевыми полотнами <strong>Clipso (Франция), Descor (Германия), Cerutti (Швейцария)</strong>. Монтаж без нагрева. Доступны матовые, акустические и цветные варианты.</p>

              <h3>Преимущества тканевых натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Тканевые потолки особенно рекомендуются для детских комнат, спален и аллергиков. Также популярны в офисах — акустические варианты Clipso поглощают эхо.</p>
            </div>
          </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость тканевого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Без ПВХ и нагрева</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии тканевых натяжных потолков</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про тканевые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Тканевые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает тканевые натяжные потолки в Иркутске с 2009 года. Работаем с Clipso, Descor, Cerutti — оплата после приёмки, даём письменную гарантию 12 лет.</p>
            <h3>Особенности тканевых потолков</h3>
            <p>Полиэстеровое полотно без ПВХ — экологически чистый материал. Монтаж без нагрева означает отсутствие химических испарений и запаха. Подходит для самых требовательных клиентов.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем тканевые потолки Clipso, Descor, Cerutti по всему Иркутску. Замер бесплатный. Гарантия 12 лет по договору.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите тканевый натяжной потолок?</h2>
...
const heroImg = usePageHero('tkanevye-natyazhnye-potolki', item.img)
