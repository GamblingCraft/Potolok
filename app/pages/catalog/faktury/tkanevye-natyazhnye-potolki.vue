      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <p class="cp-hero__price">
            ...
            Без ПВХ. Монтаж без нагрева. Без предоплаты.
          </p>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает тканевые натяжные потолки в Иркутске с 2009 года. Работаем с Clipso, Descor, Cerutti — монтируем без предоплаты, даём письменную гарантию 12 лет.</p>
