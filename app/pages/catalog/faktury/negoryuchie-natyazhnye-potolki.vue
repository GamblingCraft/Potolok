  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Негорючие натяжные потолки в&nbsp;Иркутске
          </h1>
          <p class="cp-hero__price">
            Акция: <span>3-й потолок в подарок!</span> Гарантия 12 лет.<br>
            Сертификат МЧС. Монтаж за 1 день. Оплата после приёмки.
          </p>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Негорючие натяжные потолки — противопожарные, сертификат МЧС</h2>
            <div class="cp-text" itemprop="description">
              <p>Негорючие натяжные потолки изготавливаются из материалов с антипиреновыми добавками. При воздействии огня не воспламеняются, не распространяют пламя и не выделяют токсичных продуктов горения.</p>
              <p>Используются в жилых помещениях, офисах, торговых центрах, гостиницах и государственных учреждениях, где особые требования пожарной безопасности.</p>
              <h3>Что мы предлагаем</h3>
              <p>Teqtum (единственное полотно с сертификатом МЧС России) и Descor (волокно Trevira CS). Соответствуют нормам пожарной безопасности.</p>
              <h3>Преимущества негорючих натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <p>Те же фактуры, цвета и качество поверхности, что и у обычных потолков. Разница только в составе материала. Для жилых, офисных и коммерческих объектов.</p>
            </div>
          </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость негорючего потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Сертификат МЧС</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии негорючих натяжных потолков</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про негорючие натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Негорючие натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает негорючие натяжные потолки в Иркутске. Teqtum — сертификат МЧС России. Монтаж оплата после приёмки, гарантия 12 лет.</p>
            <h3>Особенности негорючих потолков</h3>
            <p>Антипиреновые добавки не позволяют полотну воспламеняться и распространять пламя. При нагреве не выделяют токсичных продуктов горения. От 299 ₽/м².</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Устанавливаем по всему Иркутску. Замер бесплатный. Монтаж комнаты — 2–4 часа. Оплата после приёмки. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите негорючий натяжной потолок?</h2>
