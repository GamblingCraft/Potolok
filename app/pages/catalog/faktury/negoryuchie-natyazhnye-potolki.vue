      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <p class="cp-hero__price">
            ...
            Сертификат МЧС. Монтаж за 1 день. Без предоплаты.
          </p>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает негорючие натяжные потолки в Иркутске. Teqtum — сертификат МЧС России. Монтаж без предоплаты, гарантия 12 лет.</p>
