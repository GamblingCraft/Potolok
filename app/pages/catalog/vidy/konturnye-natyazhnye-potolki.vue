  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Контурные натяжные потолки в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Контурные натяжные потолки — подсветка по периметру</h2>
            <div class="cp-text" itemprop="description">
              <p>Контурный потолок — натяжное полотно с нишей по периметру или внутреннему контуру, в которую помещается LED-лента. В отличие от парящего, контур может быть не только по периметру, но и образовывать сложные геометрические формы внутри.</p>
              <p>Двойной контур — два ряда ниш на разном расстоянии от стены. Создаёт эффект глубины и объёма. Особенно эффектно в больших гостиных и залах.</p>
              <h3>Преимущества контурных натяжных потолков</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость контурного потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Подсветка по контуру</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии контурных натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на контурные потолки</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про контурные натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Контурные натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует контурные натяжные потолки в Иркутске. Без предоплаты, гарантия 12 лет.</p>
            <h3>Технология контурного потолка</h3>
            <p>Ниша по периметру или внутреннему контуру скрывает LED-ленту. Свет, исходящий из ниши, создаёт объём и глубину потолочного пространства.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем контурные потолки по всему Иркутску. Замер бесплатный. Монтаж — 1 день. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите контурный натяжной потолок?</h2>
...
const item = vidy.find(v => v.id === 'contour')!
const gallery = catalogGallery['konturnye-natyazhnye-potolki'] ?? []
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Контурные натяжные потолки в Иркутске. LED-подсветка по контуру потолка, одна или двойная ниша. Монтаж за 1 день, гарантия 12 лет.' },
    { property: 'og:title', content: 'Контурные натяжные потолки в Иркутске | ПроПотолок' },
    { property: 'og:description', content: 'Контурные потолки от 409 ₽/м². Монтаж за 1 день, гарантия 12 лет.' },
    { property: 'og:image', content: item.img },
    { property: 'og:type', content: 'product' },
  ],
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Контурные натяжные потолки', description: 'Контурные натяжные потолки с подсветкой по периметру или геометрическому контуру. Монтаж в Иркутске.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: 409, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
