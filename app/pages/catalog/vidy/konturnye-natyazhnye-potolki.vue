      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Компания <strong>ПроПотолок</strong> монтирует контурные натяжные потолки в Иркутске. Оплата после приёмки, гарантия 12 лет.</p>
...
const heroImg = usePageHero('konturnye-natyazhnye-potolki', item.img)
...
usePageSeoMeta('konturnye-natyazhnye-potolki')
