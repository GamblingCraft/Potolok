  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Криволинейные натяжные потолки в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Криволинейные натяжные потолки — волны, эллипсы, круги</h2>
            <div class="cp-text" itemprop="description">
              <p>Криволинейные натяжные потолки — конструкции с полукруглыми, эллиптическими, волнообразными или произвольными формами. Профиль FLEXY гнётся по любому радиусу, позволяя реализовать самые смелые дизайнерские идеи.</p>
              <p>Особенно популярны в ресторанах, холлах, торговых центрах. В жилых помещениях создают романтическую атмосферу — полукруглая ниша над кроватью, волнообразный переход между зонами.</p>
              <h3>Преимущества криволинейных натяжных потолков</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость криволинейного потолка онлайн</div>
          <p class="cp-calc-cta__desc">Укажите площадь и форму — калькулятор покажет предварительную цену за 1 минуту</p>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Профиль FLEXY</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии криволинейных натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на криволинейные потолки</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про криволинейные натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Криволинейные натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует криволинейные натяжные потолки в Иркутске. Профиль FLEXY — любые формы. Без предоплаты, гарантия 12 лет.</p>
            <h3>Технология криволинейного потолка</h3>
            <p>Профиль FLEXY — гибкий алюминиевый профиль — изгибается по нужной форме и фиксируется на стене. Затем на него натягивается полотно. Форма получается идеально ровной.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем криволинейные потолки по всему Иркутску. Замер бесплатный. Монтаж — 1 рабочий день. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите криволинейный натяжной потолок?</h2>
...
const item = vidy.find(v => v.id === 'curve')!
const gallery = catalogGallery['krivolinejnye-natyazhnye-potolki'] ?? []
...
useHead({
  ...
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Криволинейные натяжные потолки', description: 'Криволинейные натяжные потолки на профиле FLEXY — любые формы. Монтаж в Иркутске.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: 539, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
