  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Натяжные потолки с подсветкой в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки с подсветкой — виды и технологии</h2>
            <div class="cp-text" itemprop="description">
              <p>Натяжные потолки с подсветкой открывают безграничные возможности для создания атмосферы. Точечные споты, скрытая LED-лента, трековые системы, полупрозрачное полотно с рассеянным светом — каждый вариант даёт уникальный эффект.</p>
              <p>Светодиодная лента за полупрозрачным полотном создаёт мягкое рассеянное свечение. Точечные светильники — акцентное освещение. Трековые системы — гибкость в расположении приборов.</p>

              <h3>Что мы предлагаем</h3>
              <p><strong>Точечные споты</strong> — любые типоразмеры, встраиваемые в полотно. <strong>Трековые системы</strong> — магнитный и шинный трек. <strong>LED-подсветка</strong> в парящей нише. <strong>Полупрозрачное</strong> полотно с рассеянным светом.</p>

              <h3>Преимущества натяжных потолков с подсветкой</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка с подсветкой онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Любой вид освещения</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков с подсветкой</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки с подсветкой</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки с подсветкой в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует натяжные потолки с любым типом подсветки в Иркутске. Оплата после приёмки, письменная гарантия 12 лет.</p>
            <h3>Виды подсветки натяжных потолков</h3>
            <p>Точечные споты, трековые системы, LED-ниша (парящий эффект), полупрозрачное полотно, контурная подсветка. Каждый вариант создаёт свою атмосферу.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем потолки с любым типом освещения. Замер бесплатный. Монтаж — 1 рабочий день. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите натяжной потолок с подсветкой?</h2>
...
const heroImg = usePageHero('natyazhnye-potolki-s-podsvetkoy', item.img)
