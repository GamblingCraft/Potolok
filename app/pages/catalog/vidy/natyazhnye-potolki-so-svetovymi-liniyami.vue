  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки со световыми линиями в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки со световыми линиями — SLOTT и FLEXY</h2>
            <div class="cp-text" itemprop="description">
              <p>Световые линии — встроенные в натяжной потолок LED-профили, создающие светящиеся линии прямо в полотне. Линии выглядят как часть потолка: нет видимых крепёжных элементов, нет кабелей — только чистый свет.</p>
              <p>Используем профили <strong>SLOTT</strong> (прямые линии) и <strong>FLEXY</strong> (криволинейные). Подходят для жилых помещений, офисов, ресторанов и торговых залов. Совместимы с диммером и системами умного дома.</p>
              <h3>Что мы предлагаем</h3>
              <p>Профили SLOTT и FLEXY. LED 2700К, 3000К, 4000К, 5000К. RGB с управлением. Комбинирование с точечными светильниками. Геометрические паттерны и произвольные формы.</p>
              <h3>Преимущества натяжных потолков со световыми линиями</h3>
              <ul class="cp-list">
          ...
          <aside class="cp-aside">
            ...
            <div class="cp-aside-nav">
              ...
              <nav>
                <NuxtLink v-for="v in otherVidy" :key="v.slug" :to="v.slug" class="cp-aside-nav__link" :class="{ active: v.id === item.id }">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка со световыми линиями онлайн</div>
          <p class="cp-calc-cta__desc">Укажите площадь и длину световых линий — калькулятор покажет предварительную цену за 1 минуту</p>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Профили SLOTT и FLEXY</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков со световыми линиями</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на потолки со световыми линиями</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолки со световыми линиями</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки со световыми линиями в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует натяжные потолки со световыми линиями в Иркутске. Без предоплаты, гарантия 12 лет.</p>
            <h3>Технология световых линий</h3>
            <p>LED-профиль монтируется в специальный паз натяжного потолка до натяжения полотна. После монтажа световая линия выглядит как органичная часть потолка.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем потолки со световыми линиями по всему Иркутску. Замер бесплатный. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок со световыми линиями?</h2>
...
const item = vidy.find(v => v.id === 'lines')!
const gallery = catalogGallery['natyazhnye-potolki-so-svetovymi-liniyami'] ?? []
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Натяжные потолки со световыми линиями в Иркутске. Профили SLOTT и FLEXY — прямые и криволинейные линии. Монтаж за 1 день, гарантия 12 лет.' },
    { property: 'og:title', content: 'Натяжные потолки со световыми линиями в Иркутске | ПроПотолок' },
    { property: 'og:description', content: 'Световые линии от 439 ₽/м². Профили SLOTT и FLEXY. Монтаж за 1 день, гарантия 12 лет.' },
    { property: 'og:image', content: item.img },
    { property: 'og:type', content: 'product' },
  ],
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Натяжные потолки со световыми линиями', description: 'Натяжные потолки со встроенными световыми линиями — профили SLOTT и FLEXY. Монтаж в Иркутске.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: 439, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
...
.cp-aside-extra { font-size: 12px; color: var(--accent); font-weight: 600; margin-top: -8px; margin-bottom: 12px; }
