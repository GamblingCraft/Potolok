      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Компания <strong>ПроПотолок</strong> монтирует натяжные потолки со световыми линиями в Иркутске. Оплата после приёмки, гарантия 12 лет.</p>
...
const heroImg = usePageHero('natyazhnye-potolki-so-svetovymi-liniyami', item.img)
...
usePageSeoMeta('natyazhnye-potolki-so-svetovymi-liniyami')
