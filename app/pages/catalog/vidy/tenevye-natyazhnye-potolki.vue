  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Теневые натяжные потолки в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Теневые натяжные потолки — бесщелевое примыкание</h2>
            <div class="cp-text" itemprop="description">
              <p>Теневой потолок — современная технология, при которой натяжное полотно крепится к стене через специальный теневой профиль, создающий видимый зазор-«тень» между потолком и стеной. В этот зазор помещается LED-лента — подсветка становится невидимой.</p>
              <p>Теневой профиль создаёт эффект «парения» потолка над стеной. Зазор обычно 20–40 мм. Идеально смотрится в современных и минималистичных интерьерах.</p>
              <h3>Что мы предлагаем</h3>
              <p>Теневые профили разных размеров. LED-лента любой цветовой температуры в нише. Совместимо с точечными и трековыми светильниками. Комбинирование с другими технологиями.</p>
              <h3>Преимущества теневых натяжных потолков</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость теневого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Бесщелевое примыкание</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии теневых натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на теневые потолки</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про теневые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Теневые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует теневые натяжные потолки в Иркутске. Без предоплаты, письменная гарантия 12 лет.</p>
            <h3>Технология теневого потолка</h3>
            <p>Теневой профиль крепится к стене по периметру помещения. Натяжное полотно заправляется в профиль, образуя чистый зазор. В зазор укладывается LED-лента.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем теневые потолки по всему Иркутску. Замер бесплатный. Монтаж — 1 день. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите теневой натяжной потолок?</h2>
...
const item = vidy.find(v => v.id === 'shadow')!
const gallery = catalogGallery['tenevye-natyazhnye-potolki'] ?? []
...
useHead({
  ...
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Теневые натяжные потолки', description: 'Теневые натяжные потолки с бесщелевым примыканием и скрытой LED-подсветкой. Монтаж в Иркутске.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: 359, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
