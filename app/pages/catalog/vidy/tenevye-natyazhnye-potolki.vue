      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Компания <strong>ПроПотолок</strong> монтирует теневые натяжные потолки в Иркутске. Оплата после приёмки, письменная гарантия 12 лет.</p>
...
const _content = await usePageContent('tenevye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('tenevye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('tenevye-natyazhnye-potolki'))
...
const heroImg = usePageHero('tenevye-natyazhnye-potolki', item.img)
