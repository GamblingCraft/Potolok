  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Двухуровневые натяжные потолки в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Двухуровневые натяжные потолки — зонирование и стиль</h2>
            <div class="cp-text" itemprop="description">
              <p>Двухуровневый натяжной потолок — конструкция из двух полотен на разных высотах, соединённых алюминиевым профилем. Позволяет зонировать пространство, скрыть коммуникации и создать выразительный дизайн с подсветкой.</p>
              <p>Нижний уровень может быть на 15–30 см ниже основного — именно в это пространство прячутся трубы, вентиляция и проводка. Между уровнями размещается LED-лента, создающая эффект парения нижнего уровня.</p>
              <h3>Что мы предлагаем</h3>
              <p>Монтируем двухуровневые потолки любой сложности: прямые, криволинейные, с парящей нишей. Разные фактуры на каждом уровне — матовый + глянцевый, белый + чёрный. Профили любой формы.</p>
              <h3>Преимущества двухуровневых натяжных потолков</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость двухуровневого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Зонирование пространства</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии двухуровневых натяжных потолков</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про двухуровневые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Двухуровневые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует двухуровневые натяжные потолки в Иркутске. Оплата после приёмки, письменная гарантия 12 лет.</p>
            <h3>Конструкция двухуровневого потолка</h3>
            <p>Два натяжных полотна соединяются профилем. В пространстве между ними скрываются коммуникации и LED-лента. Нижний уровень создаёт эффект зонирования.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем двухуровневые потолки по всему Иркутску. Замер бесплатный. Монтаж — 1 рабочий день. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите двухуровневый натяжной потолок?</h2>
...
const heroImg = usePageHero('dvuhurovnevye-natyazhnye-potolki', item.img)
