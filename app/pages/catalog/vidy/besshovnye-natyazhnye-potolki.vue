    ...
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          <div class="cp-pretitle">Вид / технология</div>
          ...
          <p class="cp-hero__price">
            ...
            Ширина до 5 м — без швов. Монтаж за 1 день. Оплата после приёмки.
          </p>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает бесшовные натяжные потолки в Иркутске с 2009 года. Оплата после приёмки, гарантия 12 лет.</p>
...
const _content = await usePageContent('besshovnye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('besshovnye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('besshovnye-natyazhnye-potolki'))
const _prices = await useCatalogPrices()
const price = computed(() => _prices.value?.['besshovnye'] ?? item.price)

const item = faktury.find(f => f.id === 'bess')!
const heroImg = usePageHero('besshovnye-natyazhnye-potolki', item.img)
