  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Потолок Звёздное небо — оптоволокно с мерцанием</h2>
            <div class="cp-text" itemprop="description">
              <p>Потолок «Звёздное небо» — тканевое или матовое полотно с пропущенными через него оптоволоконными нитями. Концы нитей светятся и мерцают, имитируя настоящие звёзды. Управление цветом и мерцанием — с пульта или приложения.</p>
              <p>Устанавливается от 150 до 1000 и более оптоволоконных нитей в зависимости от площади. Можно добавить эффект падающей звезды, поменять цвет свечения, настроить интенсивность. Идеально для детских, спален, SPA и ресторанов.</p>
              <h3>Что мы предлагаем</h3>
              <p>Оптоволоконные потолки на тканевых и матовых полотнах. Количество звёзд: от 150 до 1000+. Цвета: белый, синий, RGB-мерцание. Управление: пульт, приложение, умный дом.</p>
              <h3>Преимущества потолка Звёздное небо</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка Звёздное небо онлайн</div>
          <p class="cp-calc-cta__desc">Укажите площадь и количество звёзд — калькулятор покажет предварительную цену за 1 минуту</p>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Оптоволоконная магия</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков Звёздное небо</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолок Звёздное небо</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Потолок Звёздное небо в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует потолки Звёздное небо в Иркутске. Оплата после приёмки, письменная гарантия 12 лет.</p>
            <h3>Технология Звёздное небо</h3>
            <p>Оптоволоконные нити пропускаются через полотно и подключаются к LED-источнику. Мерцание создаётся специальным диском внутри источника. Всё управление — снаружи.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем потолки Звёздное небо по всему Иркутску. Замер бесплатный. Монтаж — 1 рабочий день. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок Звёздное небо?</h2>
...
const heroImg = usePageHero('natyazhnye-potolki-zvezdnoe-nebo', item.img)
