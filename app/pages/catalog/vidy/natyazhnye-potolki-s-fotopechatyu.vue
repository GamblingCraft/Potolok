  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки с фотопечатью в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки с фотопечатью — уникальный рисунок на потолке</h2>
            <div class="cp-text" itemprop="description">
              <p>Натяжной потолок с фотопечатью — любой рисунок, фотография или узор, нанесённый на матовое или тканевое полотно методом УФ-печати. Разрешение HD — изображение выглядит чётко даже на больших площадях.</p>
              <p>В нашем каталоге — сотни готовых принтов: облака, звёздное небо, лесные пейзажи, абстракции, морские виды. Или распечатаем ваш рисунок — достаточно прислать изображение с высоким разрешением.</p>
              <h3>Что мы предлагаем</h3>
              <p>Каталог из 500+ готовых принтов. Печать вашего изображения (минимум 3000×3000px). Совместимо с точечными светильниками. Гипоаллергенные чернила без запаха.</p>
              <h3>Преимущества натяжных потолков с фотопечатью</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка с фотопечатью онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Уникальный дизайн</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков с фотопечатью</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на потолки с фотопечатью</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки с фотопечатью</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки с фотопечатью в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует натяжные потолки с фотопечатью в Иркутске. Каталог 500+ принтов или ваш рисунок. Без предоплаты, гарантия 12 лет.</p>
            <h3>Технология фотопечати</h3>
            <p>УФ-печать наносится непосредственно на натяжное полотно до монтажа. После установки изображение выглядит как часть потолка — без стыков и рамок.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем потолки с фотопечатью по всему Иркутску. Замер и консультация бесплатны. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите натяжной потолок с фотопечатью?</h2>
...
const gallery = catalogGallery['natyazhnye-potolki-s-fotopechatyu'] ?? []
...
useHead({
  ...
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Натяжные потолки с фотопечатью', description: 'Натяжные потолки с фотопечатью — любой рисунок, УФ-печать, 500+ принтов. Монтаж в Иркутске.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: 559, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
