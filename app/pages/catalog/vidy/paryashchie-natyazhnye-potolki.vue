  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Парящие натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          ...
          <div class="cp-main">
            <h2 class="cp-h2">Парящие натяжные потолки — эффект левитации</h2>
            <div class="cp-text" itemprop="description">
              <p>Парящий потолок — современный тренд в дизайне интерьера. Технология основана на специальном профиле, который крепится к стене и позволяет скрыть светодиодную ленту по периметру. Свет, бьющий из невидимой ниши, создаёт ощущение, что потолок «парит» в воздухе.</p>
              <p>Эффект парения усиливается при дополнительном точечном освещении. Матовое белое полотно в этой технологии сложно отличить от гипсокартона — только натяжные потолки монтируются за 1 день без пыли и грязи.</p>

              <h3>Что мы предлагаем</h3>
              <p>Монтируем парящие потолки с профилями <strong>FLEXY</strong> и <strong>SLOTT</strong>. LED-лента любого цвета и цветовой температуры. Совместимо с точечными светильниками и трековыми системами.</p>

              <h3>Преимущества парящих натяжных потолков</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость парящего потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Эффект левитации</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии парящих натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на парящие потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Тренд 2024–2026</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия на парящий потолок — 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про парящие натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Парящие натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает парящие натяжные потолки в Иркутске. Работаем с профессиональными профилями FLEXY и SLOTT, монтируем без предоплаты, даём письменную гарантию 12 лет.</p>
            <h3>Технология парящего потолка</h3>
            <p>Парящий потолок монтируется на профиль, установленный на 5–15 см ниже базового потолка. В образовавшуюся нишу укладывается LED-лента. Снаружи ниша не видна — виден только свет.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Устанавливаем парящие потолки по всему Иркутску. Замер бесплатный. Монтаж — 1 рабочий день. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите парящий натяжной потолок?</h2>
...
const item = vidy.find(v => v.id === 'pary')!
const gallery = catalogGallery['paryashchie-natyazhnye-potolki'] ?? []
