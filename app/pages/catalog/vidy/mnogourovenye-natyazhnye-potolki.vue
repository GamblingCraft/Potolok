  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Многоуровневые натяжные потолки в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Многоуровневые натяжные потолки — три и более уровней</h2>
            <div class="cp-text" itemprop="description">
              <p>Многоуровневые натяжные потолки — три и более уровней полотна на разных высотах. Самый выразительный и статусный вид натяжных потолков. Требует профессионального проектирования и опытных мастеров.</p>
              <p>Каждый уровень может иметь свою фактуру, цвет и подсветку. Пространство между уровнями используется для скрытия коммуникаций, вентиляции и LED-лент. Индивидуальный проект для каждого заказчика.</p>
              <h3>Преимущества многоуровневых натяжных потолков</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость многоуровневого потолка онлайн</div>
          <p class="cp-calc-cta__desc">Укажите площадь и количество уровней — калькулятор покажет предварительную цену за 1 минуту</p>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Сложная геометрия</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии многоуровневых натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на многоуровневые потолки</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про многоуровневые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Многоуровневые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> монтирует многоуровневые натяжные потолки в Иркутске. Индивидуальные проекты, без предоплаты, гарантия 12 лет.</p>
            <h3>Конструкция многоуровневого потолка</h3>
            <p>Три и более натяжных полотна на разных высотах, соединённых профилями. В пространстве между уровнями — коммуникации и LED-ленты. Каждый уровень может иметь свою фактуру.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем многоуровневые потолки по всему Иркутску. Замер и проектирование бесплатны. Гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите многоуровневый натяжной потолок?</h2>
          <p class="cp-cta__desc">Вызовите замерщика — приедет бесплатно, разработает проект и рассчитает стоимость на месте</p>
        </div>
...
const item = vidy.find(v => v.id === 'many')!
const gallery = catalogGallery['mnogourovenye-natyazhnye-potolki'] ?? []
...
useHead({
  ...
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Многоуровневые натяжные потолки', description: 'Многоуровневые натяжные потолки — три и более уровней, сложная геометрия. Монтаж в Иркутске.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: 609, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
...
const promos = [
  ...
  { icon: 'lucide:credit-card', title: 'Рассрочка 0% до 3 мес.',      desc: 'Оформим рассрочку без переплаты. Первый взнос 0%. Монтаж — в тот же день.', date: 'Без переплаты' },
]
const whyCards = [
