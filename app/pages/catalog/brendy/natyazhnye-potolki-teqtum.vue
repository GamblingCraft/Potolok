  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки Teqtum — прошли испытания МЧС</h2>
            <div class="cp-text" itemprop="description">
              <p>Teqtum — полотно нового поколения. <strong>Единственная плёнка в России, прошедшая испытания МЧС</strong>. Обладает наивысшими противопожарными характеристиками среди натяжных потолков. Разрешена для установки в государственных учреждениях, больницах, школах и детских садах.</p>
              <p>Особенность Teqtum — полное отсутствие формальдегидов и других токсичных летучих веществ. Это делает его безусловно безопасным для всех категорий жильцов, включая детей, аллергиков и людей с хроническими заболеваниями.</p>
              <h3>Ключевые сертификаты Teqtum</h3>
              <ul class="cp-list">
                <li><strong>Сертификат МЧС России.</strong> Единственный натяжной потолок, прошедший полные противопожарные испытания МЧС.</li>
                <li><strong>Экологическая сертификация EU.</strong> Соответствие строгим европейским нормам по безопасности материалов.</li>
                <li><strong>Сертификат термоустойчивости.</strong> Сохраняет характеристики при температурах от -10°C до +70°C.</li>
                <li><strong>Санитарно-эпидемиологическое заключение.</strong> Разрешён к применению в медучреждениях и детских садах.</li>
              </ul>
              <h3>Преимущества Teqtum</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка Teqtum онлайн</div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Сертификат МЧС России</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия на потолки Teqtum — 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фото потолков Teqtum</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолки Teqtum</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки Teqtum в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> предлагает монтаж потолков Teqtum в Иркутске. Это оптимальный выбор для тех, кому важна максимальная пожарная безопасность и экологичность — особенно актуально для детских комнат и помещений с особыми требованиями.</p>
            <h3>Где применяется Teqtum</h3>
            <p>Teqtum устанавливают в квартирах, домах, медицинских учреждениях, детских садах, санаториях и операционных. Единственный бренд, имеющий официальное разрешение МЧС России для применения в общественных зданиях.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем Teqtum по всему Иркутску. Бесплатный выезд замерщика. Монтаж комнаты — 2–4 часа. Гарантия 12 лет по договору. Оплата после приёмки работ.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок Teqtum?</h2>
...
const heroImg = usePageHero('natyazhnye-potolki-teqtum', item.img)
