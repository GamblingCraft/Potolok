  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки LumFer — двухслойное немецкое полотно</h2>
            <div class="cp-text" itemprop="description">
              <p>LumFer — уникальное двухслойное ПВХ-полотно немецкой компании <strong>Ferico GBR</strong>. В отличие от обычных однослойных плёнок, LumFer состоит из двух слоёв, что делает его значительно прочнее, плотнее и долговечнее.</p>
              <p>Внутренний слой всегда чёрного цвета — он полностью не пропускает свет. Это исключает возможность просвечивания скрытых коммуникаций, крепёжных элементов и тёмных участков базового потолка. Идеальный выбор для помещений с подсветкой.</p>
              <h3>Конструкция LumFer</h3>
              <ul class="cp-list">
                <li><strong>Толщина 32 мм.</strong> Значительно толще стандартных аналогов — не вибрирует и не шелестит при сквозняках.</li>
                <li><strong>Чёрный внутренний слой.</strong> Полностью непрозрачен — никаких просветов со стороны коммуникаций или светильников.</li>
                <li><strong>Не воспламеняется.</strong> Не горит и не выделяет неприятных запахов при нагреве.</li>
                <li><strong>Совместим с любыми светильниками.</strong> Галогенные, точечные, треки, LED — всё монтируется без просвечивания.</li>
              </ul>
              <h3>Преимущества LumFer</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка LumFer онлайн</div>
          <p class="cp-calc-cta__desc">Укажите площадь и тип помещения — калькулятор покажет итоговую цену за минуту</p>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Двухслойная технология</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия на потолки LumFer — 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фото потолков LumFer</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолки LumFer</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки LumFer в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает потолки LumFer под ключ. Двухслойное немецкое полотно — лучший выбор для помещений с точечными светильниками, трековыми системами и скрытой подсветкой.</p>
            <h3>Где применяется LumFer</h3>
            <p>LumFer особенно востребован в гостиных и коридорах с трековыми светильниками — чёрный внутренний слой полностью исключает просвечивание держателей и проводки. Также популярен в спальнях с LED-подсветкой за карнизом.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Монтируем LumFer по всему Иркутску. Бесплатный выезд замерщика. Монтаж комнаты — 2–4 часа. Гарантия 12 лет по договору. Оплата после приёмки работ.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок LumFer?</h2>
...
const heroImg = usePageHero('natyazhnye-potolki-lumfer', item.img)
...
const whyCards = [
  ...
  { icon: 'lucide:shield-check', title: 'Гарантия 12 лет', desc: 'Письменная гарантия по договору на полотно и монтаж. Без скрытых условий.' },
