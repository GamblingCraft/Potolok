  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки Bauf — немецкое качество</h2>
            <div class="cp-text" itemprop="description">
              <p>Bauf — немецкий бренд ПВХ-полотен, производство которых ведётся в Китае по немецким технологиям. Это позволяет сохранять высокое качество при конкурентных ценах. Полотна имеют маркировку <strong>A+</strong> — наивысший экологический класс, означающий, что воздух в помещении с таким потолком абсолютно чист.</p>
              <p>Bauf прошёл проверку на 178 вредных веществ — ни одного не обнаружено. Четыре независимых сертификата качества подтверждают экологическую безопасность. Рекомендован для установки в детских комнатах, спальнях и медицинских учреждениях.</p>
              <h3>Особенности полотен Bauf</h3>
              <ul class="cp-list">
                <li><strong>Маркировка A+.</strong> Высший экологический класс — полотно не выделяет токсичных веществ даже при нагреве.</li>
                <li><strong>4 сертификата качества.</strong> Международные сертификаты экологичности и безопасности материала.</li>
                <li><strong>Влагостойкая пропитка.</strong> Специальный состав повышает устойчивость к влаге — подходит для ванных и бассейнов.</li>
                <li><strong>Немецкие технологии.</strong> Производство по стандартам Германии даёт стабильное качество в каждом рулоне.</li>
              </ul>
              <h3>Преимущества Bauf</h3>
              <ul class="cp-list">
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Бесплатно привезём образцы Bauf, рассчитаем стоимость и оформим договор</p>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка Bauf онлайн</div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Экологический класс A+</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия на потолки Bauf — 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фото потолков Bauf</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолки Bauf</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки Bauf в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> предлагает монтаж натяжных потолков Bauf под ключ. Немецкий бренд с маркировкой A+ — идеальный выбор для семей с детьми и людей, заботящихся об экологии жилья.</p>
            <h3>Почему Bauf популярен в Иркутске</h3>
            <p>Bauf сочетает доступную цену с высоким качеством европейского уровня. Четыре международных сертификата, отсутствие токсичных веществ и проверенная немецкая технология делают этот бренд одним из самых востребованных у наших клиентов.</p>
            <h3>Монтаж Bauf в Иркутске</h3>
            <p>Устанавливаем потолки Bauf по всему Иркутску. Замер бесплатный. Монтаж комнаты до 20 м² — 2–4 часа. Оплата после приёмки работ. Гарантия 12 лет по договору.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок Bauf?</h2>
...
const item = brendy.find(b => b.id === 'bauf')!
const otherBrendy = brendy.map(b => ({ id: b.id, slug: b.slug, title: b.title }))
const gallery = catalogGallery['natyazhnye-potolki-bauf'] ?? []
...
const whyCards = [
  { icon: 'lucide:leaf', title: 'Класс A+ — без токсинов', desc: 'Полотно проверено на 178 вредных веществ. Безопасно для детей, аллергиков и пожилых.' },
...
@media (max-width: 768px) { .cp-works-grid { grid-template-columns: repeat(2, 1fr); } .cp-gallery-grid { grid-template-columns: repeat(2, 1fr); } }
