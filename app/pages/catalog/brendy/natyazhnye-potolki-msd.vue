  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки MSD — преимущества и описание</h2>
            <div class="cp-text" itemprop="description">
              <p>MSD — один из самых популярных брендов натяжных потолков в России. Завод производит ПВХ-полотна по европейским стандартам качества и предлагает три серии: <strong>Classic, Evolution и Premium</strong>. Широкий модельный ряд позволяет подобрать оптимальный вариант под любой бюджет и помещение.</p>
              <p>Полотна MSD применяются в гостиных, спальнях, кухнях, ванных и детских комнатах, а также в офисных и медицинских учреждениях. Доступные цены и стабильное качество делают этот бренд выбором №1 для большинства иркутских квартир.</p>
              <h3>Серии полотен MSD</h3>
              <ul class="cp-list">
                <li><strong>Classic.</strong> Эконом-класс для технических и нежилых помещений. Стандартная толщина, широкая цветовая гамма.</li>
                <li><strong>Evolution.</strong> Улучшенный состав, повышенная эластичность. Подходит для жилых комнат любой сложности.</li>
                <li><strong>Premium.</strong> Максимальная плотность и долговечность. Рекомендуется для гостиных и помещений с нестандартной геометрией.</li>
              </ul>
              <h3>Преимущества полотен MSD</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка MSD онлайн</div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Проверено в Иркутске</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия на потолки MSD — 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фото потолков MSD</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолки MSD</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки MSD в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> работает с полотнами MSD с момента открытия. Это один из самых востребованных брендов — огромный выбор фактур и цветов, стабильное качество и доступная цена.</p>
            <h3>Чем MSD лучше аналогов</h3>
            <p>Завод MSD производит полотна на современном оборудовании по европейским стандартам. Все материалы сертифицированы, имеют санитарно-эпидемиологическое заключение. Серия Evolution и Premium отличается повышенной эластичностью — полотно идеально натягивается даже в помещениях сложной формы.</p>
            <h3>Установка в Иркутске</h3>
            <p>Монтируем потолки MSD по всему Иркутску и пригороду. Выезд замерщика бесплатный. Монтаж стандартной комнаты — 2–4 часа, вся квартира — 1 рабочий день. Оплата после приёмки работ.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок MSD?</h2>
