  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки Descor — тканевое полотно из Германии</h2>
            <div class="cp-text" itemprop="description">
              <p>Descor — немецкий бренд тканевых натяжных потолков из волокна <strong>Trevira CS</strong>. Полотно не содержит ПВХ и изготовлено из высококачественного синтетического текстиля с огнеупорными свойствами. Материал соответствует требованиям ГОСТ России и европейским стандартам пожарной безопасности.</p>
              <p>Тканевые потолки Descor легко моются с применением моющих средств, не боятся влаги и сохраняют форму на протяжении всего срока эксплуатации. Высокий запас прочности и защита от разрыва делают их надёжным выбором для жилых и коммерческих помещений.</p>
              <h3>Особенности полотен Descor</h3>
              <ul class="cp-list">
                <li><strong>Волокно Trevira CS.</strong> Запатентованное огнеупорное волокно — пожарная безопасность заложена в структуру материала, не смывается.</li>
                <li><strong>Без ПВХ.</strong> Экологически чистое тканевое полотно без токсичных пластификаторов и хлора.</li>
                <li><strong>Легко моётся.</strong> Поверхность допускает влажную уборку с моющими средствами без потери вида.</li>
                <li><strong>Немецкие технологии и ГОСТ.</strong> Производство соответствует немецким стандартам и требованиям российской сертификации.</li>
              </ul>
              <h3>Преимущества Descor</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка Descor онлайн</div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Тканевое полотно Trevira CS</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия на потолки Descor — 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фото потолков Descor</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолки Descor</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки Descor в Иркутске — тканевые от 319 ₽/м²</h2>
            <p>Компания <strong>ПроПотолок</strong> предлагает монтаж тканевых натяжных потолков Descor под ключ. Немецкое волокно Trevira CS — идеальный выбор для тех, кто ценит экологичность и пожарную безопасность.</p>
            <h3>Почему Descor популярен в Иркутске</h3>
            <p>Descor сочетает натуральный вид тканевого полотна с практичными характеристиками: огнеупорность, лёгкий уход, отсутствие токсичных веществ. Подходит для спален, детских комнат и офисов.</p>
            <h3>Монтаж Descor в Иркутске</h3>
            <p>Устанавливаем потолки Descor по всему Иркутску. Замер бесплатный. Монтаж комнаты до 20 м² — 2–4 часа. Оплата после приёмки работ. Гарантия 12 лет по договору.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок Descor?</h2>
...
const heroImg = usePageHero('natyazhnye-potolki-descor', item.img)
