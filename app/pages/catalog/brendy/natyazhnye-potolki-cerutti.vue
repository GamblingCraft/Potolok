  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки Cerutti — швейцарский люкс</h2>
            <div class="cp-text" itemprop="description">
              <p>Cerutti — швейцарский дом текстиля, работающий в люкс-сегменте натяжных потолков. Безупречно ровное белоснежное покрытие достигается благодаря высочайшей точности производственного процесса. Каждое полотно — результат многолетней экспертизы швейцарских мастеров.</p>
              <p>Производство Cerutti построено на принципах экологичности: минимизация энергозатрат и сточных вод на всех этапах. Влагозащитный лак не позволяет воде впитываться в ткань, а высокопрочное полимерное покрытие обеспечивает надёжную защиту от протечек. Идеальный выбор для требовательных клиентов с дорогим ремонтом.</p>
              <h3>Особенности полотен Cerutti</h3>
              <ul class="cp-list">
                <li><strong>Безупречно ровное покрытие.</strong> Швейцарская точность производства — идеально ровная поверхность без волн и неровностей.</li>
                <li><strong>Влагозащитный лак.</strong> Специальное покрытие не даёт воде впитываться в ткань при случайном попадании.</li>
                <li><strong>Высокопрочное полимерное покрытие.</strong> Защита от протечек сверху — полотно выдерживает серьёзную нагрузку.</li>
                <li><strong>Экологичное производство.</strong> Минимизация отходов, энергозатрат и сточных вод — ответственный подход к природе.</li>
              </ul>
              <h3>Преимущества Cerutti</h3>
              <ul class="cp-list">
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Бесплатно привезём образцы Cerutti, рассчитаем стоимость и оформим договор</p>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка Cerutti онлайн</div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Швейцарский люкс-сегмент</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия на потолки Cerutti — 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фото потолков Cerutti</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолки Cerutti</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки Cerutti в Иркутске — швейцарский люкс от 490 ₽/м²</h2>
            <p>Компания <strong>ПроПотолок</strong> предлагает монтаж натяжных потолков Cerutti под ключ. Швейцарский дом текстиля, люкс-сегмент — для дорогих интерьеров, где важен каждый миллиметр.</p>
            <h3>Почему Cerutti — выбор требовательных клиентов</h3>
            <p>Cerutti выбирают владельцы дорогих квартир, дизайнеры и застройщики премиум-класса. Безупречная ровность покрытия, швейцарское происхождение и экологичное производство — аргументы для тех, кто привык к лучшему.</p>
            <h3>Монтаж Cerutti в Иркутске</h3>
            <p>Устанавливаем потолки Cerutti по всему Иркутску. Замер бесплатный. Монтаж комнаты до 20 м² — 2–4 часа. Оплата после приёмки работ. Гарантия 12 лет по договору.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок Cerutti?</h2>
...
const item = brendy.find(b => b.id === 'cerutti')!
const otherBrendy = brendy.map(b => ({ id: b.id, slug: b.slug, title: b.title }))
const gallery = catalogGallery['natyazhnye-potolki-cerutti'] ?? []
...
const whyCards = [
  { icon: 'lucide:gem', title: 'Швейцария — люкс-сегмент', desc: 'Швейцарский дом текстиля высшего класса — каждое полотно соответствует стандартам премиум-рынка.' },
