  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки Pongs — премиум ПВХ из Германии</h2>
            <div class="cp-text" itemprop="description">
              <p>Pongs — немецкий бренд премиального сегмента с безупречным качеством ПВХ-полотен. Главное отличие: использование пластификатора <strong>DOTP</strong> вместо токсичного DOP. DOTP нетоксичен, не выделяет вредных веществ и соответствует самым строгим европейским экологическим нормам.</p>
              <p>Полотна Pongs выпускаются шириной до 325 см — это позволяет монтировать бесшовные потолки в большинстве жилых помещений. Температурный диапазон от +3 до +50°C гарантирует стабильность как в жаркие летние дни, так и при проветривании зимой. При затоплении выдерживает нагрузку до 100 л/м².</p>
              <h3>Особенности полотен Pongs</h3>
              <ul class="cp-list">
                <li><strong>Пластификатор DOTP.</strong> Нетоксичный заменитель DOP — без запаха, без вредных выбросов, одобрен для жилых помещений.</li>
                <li><strong>Ширина до 325 см.</strong> Бесшовный монтаж в большинстве комнат без видимых швов на потолке.</li>
                <li><strong>Температурный диапазон +3..+50°C.</strong> Не деформируется при экстремальных температурах — подходит для любых помещений.</li>
                <li><strong>Водонепроницаемость 100 л/м².</strong> Надёжная защита при затоплении сверху без риска прорыва.</li>
              </ul>
              <h3>Преимущества Pongs</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка Pongs онлайн</div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Премиум ПВХ — пластификатор DOTP</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия на потолки Pongs — 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Фото потолков Pongs</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про потолки Pongs</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки Pongs в Иркутске — от 349 ₽/м² с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> предлагает монтаж натяжных потолков Pongs под ключ. Немецкий премиум с безопасным пластификатором DOTP — для тех, кто не экономит на качестве ремонта.</p>
            <h3>Почему Pongs — лучший выбор в премиум-сегменте</h3>
            <p>Pongs сочетает технологическое превосходство (DOTP, ширина 325 см, широкий температурный диапазон) с безупречным немецким качеством. Это потолок для взыскательных клиентов, которые хотят результат без компромиссов.</p>
            <h3>Монтаж Pongs в Иркутске</h3>
            <p>Устанавливаем потолки Pongs по всему Иркутску. Замер бесплатный. Монтаж комнаты до 20 м² — 2–4 часа. Оплата после приёмки работ. Гарантия 12 лет по договору.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите потолок Pongs?</h2>
...
const heroImg = usePageHero('natyazhnye-potolki-pongs', item.img)
