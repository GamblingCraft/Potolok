  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Золотые натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Золотые натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Золотой натяжной потолок — воплощение роскоши и изысканного вкуса. Тёплый металлический блеск создаёт ощущение торжественности и богатства, превращая гостиную или ресторан в пространство с характером.</p>
              <p>При правильном освещении золотой потолок не выглядит вычурно — он гармонично дополняет классический, арт-деко или современный люкс интерьер с тёплыми акцентами.</p>

              <h3>Оттенки золотого</h3>
              <p>В нашем каталоге: матовое шампанское золото, глянцевое яркое золото, розовое золото, античное бронзовое золото. Замерщик привезёт образцы, чтобы вы оценили эффект при вашем освещении.</p>

              <h3>Преимущества золотых натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Золотые потолки востребованы в гостиных, ресторанах, банкетных залах, спа-центрах и бутиках. В жилых интерьерах — как акцент в одном помещении, обычно гостиной или столовой.</p>
            </div>
          </div>
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Замерщик приедет бесплатно, покажет образцы золотых оттенков, рассчитает стоимость и оформит договор</p>
    ...
    <section class="cp-section cp-works" v-if="worksWithPrice.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Золотые натяжные потолки — фото работ с ценами</h2>
          <p class="cp-section-desc">Примеры монтажа золотых потолков в квартирах и коммерческих объектах Иркутска</p>
        </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость золотого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Роскошь и элегантность</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии золотых натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на золотые потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Люкс без компромиссов</div>
          <h2 class="cp-h2 cp-h2--center">Золотой потолок — престиж и гарантия 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про золотые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Золотые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает золотые натяжные потолки в Иркутске с 2009 года. Золотой потолок — премиальный выбор для гостиных, ресторанов и банкетных залов, где важна атмосфера роскоши и торжественности.</p>
            <h3>Виды золотых натяжных потолков</h3>
            <p>Матовое золото — сдержанная роскошь без резких бликов, лучший выбор для жилых интерьеров. Глянцевое золото — яркий зеркальный эффект с золотистым отражением. Розовое золото — модный премиальный оттенок для современного люкс-интерьера.</p>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите золотой натяжной потолок?</h2>
...
const _content = await usePageContent('zolotye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('zolotye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('zolotye-natyazhnye-potolki'))
const _prices = await useCatalogPrices()
const price = computed(() => _prices.value?.['base'] ?? item.price)

const item = tsveta.find(c => c.id === 'gold')!
const heroImg = usePageHero('zolotye-natyazhnye-potolki', item.img)
...
const whyCards = [
  { icon: 'lucide:crown', title: 'Премиальные полотна', desc: 'Золотые оттенки изготавливаются из премиальных европейских полотен с металлизированным эффектом — MSD, Teqtum.' },
  ...
  { icon: 'lucide:lightbulb', title: 'Консультация по освещению', desc: 'Подскажем, какой тип и температуру света выбрать, чтобы золотой потолок смотрелся максимально выигрышно.' },
]
