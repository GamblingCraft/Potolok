  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Голубые натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Голубые натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Голубой натяжной потолок — символ свежести, открытого пространства и лёгкости. Небесный оттенок визуально поднимает потолок, создавая ощущение простора и воздушности. Голубой потолок особенно хорош в детских и спальнях, где важна атмосфера спокойствия.</p>
              <p>Доступен во всех фактурах: матовая создаёт эффект неба, глянцевая — отражает свет с холодным блеском, сатиновая — деликатный шёлковый оттенок.</p>

              <h3>Оттенки голубого</h3>
              <p>В нашем каталоге: нежный пастельный голубой, небесно-голубой, бирюзовый, ледяной, стальной голубой. Замерщик привезёт образцы для сравнения при вашем освещении.</p>

              <h3>Преимущества голубых натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Голубой потолок идеален для детских комнат, спален, ванных комнат, балконов и небольших кабинетов. Прекрасно сочетается с белыми стенами и светлой мебелью.</p>
            </div>
          </div>
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Замерщик приедет бесплатно, покажет образцы голубых оттенков, рассчитает стоимость и оформит договор</p>
    ...
    <section class="cp-section cp-works" v-if="worksWithPrice.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Голубые натяжные потолки — фото работ с ценами</h2>
          <p class="cp-section-desc">Примеры монтажа голубых потолков в квартирах Иркутска с указанием площади и стоимости</p>
        </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость голубого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Свежесть и простор</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии голубых натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на голубые потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Спокойствие и свежесть</div>
          <h2 class="cp-h2 cp-h2--center">Голубой потолок — уют и гарантия 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про голубые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Голубые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает голубые натяжные потолки в Иркутске с 2009 года. Голубой потолок создаёт атмосферу свежести и простора — идеальный выбор для спален, детских и ванных комнат.</p>
            <h3>Виды голубых натяжных потолков</h3>
            <p>Матовые голубые — эффект неба, рассеянный свет без бликов. Глянцевые — зеркальный эффект с холодным голубым отблеском, визуально увеличивает пространство. Сатиновые — деликатный шёлковый оттенок, универсальны для любого интерьера.</p>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите голубой натяжной потолок?</h2>
...
const _content = await usePageContent('golubye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('golubye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('golubye-natyazhnye-potolki'))
const _prices = await useCatalogPrices()
const price = computed(() => _prices.value?.['base'] ?? item.price)

const item = tsveta.find(c => c.id === 'blue')!
const heroImg = usePageHero('golubye-natyazhnye-potolki', item.img)
...
const whyCards = [
  { icon: 'lucide:wind', title: 'Эффект открытого неба', desc: 'Матовый голубой потолок создаёт иллюзию открытого неба — особенно с точечной подсветкой по периметру.' },
  ...
  { icon: 'lucide:droplets', title: 'Водонепроницаемость', desc: 'Натяжной потолок удержит до 100 л воды при протечке соседей сверху — защита для всей квартиры.' },
]
