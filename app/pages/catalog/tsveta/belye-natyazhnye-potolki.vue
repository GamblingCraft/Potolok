  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Белые натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Белые натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Белый натяжной потолок — вечная классика, которую выбирают более половины заказчиков. Безупречно белая поверхность делает любое помещение светлее, визуально поднимает потолок и идеально вписывается в любой стиль — от минимализма до классики.</p>
              <p>Доступен во всех фактурах: матовая для равномерного рассеивания света, глянцевая для зеркального эффекта и увеличения пространства, сатиновая — золотая середина между ними.</p>

              <h3>Оттенки белого</h3>
              <p>В нашем каталоге — более 30 оттенков белого: холодный арктический белый, тёплый молочный, слоновая кость, жемчужный, снежный. Замерщик привезёт образцы — выберете прямо у себя дома.</p>

              <h3>Преимущества белых натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Белый потолок — универсальное решение для любого помещения: гостиная, спальня, кухня, ванная, детская, офис. Сочетается с любым цветом стен и мебели.</p>
            </div>
          </div>
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Замерщик приедет бесплатно, покажет образцы белых оттенков, рассчитает стоимость и оформит договор</p>
    ...
    <section class="cp-section cp-works" v-if="worksWithPrice.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Белые натяжные потолки — фото работ с ценами</h2>
          <p class="cp-section-desc">Примеры монтажа белых потолков в квартирах Иркутска с указанием площади и стоимости</p>
        </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость белого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Более 30 оттенков</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии белых натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на белые потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Белый цвет без пожелтения</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия белизны и качества 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про белые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Белые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает белые натяжные потолки в Иркутске с 2009 года. Работаем с полотнами европейских брендов: MSD, Bauf (Германия), Teqtum, Clipso.</p>
            <h3>Виды белых натяжных потолков</h3>
            <p>Матовые белые — самый популярный вариант: равномерный свет, скрывает неровности, не бликует. Глянцевые — зеркальный эффект, визуально увеличивают пространство. Сатиновые — мягкий шёлковый блеск, универсальны для любого интерьера.</p>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите белый натяжной потолок?</h2>
...
const _content = await usePageContent('belye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('belye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('belye-natyazhnye-potolki'))
...
const heroImg = usePageHero('belye-natyazhnye-potolki', item.img)
...
const whyCards = [
  { icon: 'lucide:sun', title: 'Не желтеет годами', desc: 'Стабилизаторы UV в составе ПВХ-плёнки защищают от пожелтения на весь срок службы — 25–30 лет.' },
  { icon: 'lucide:badge-check', title: 'Европейские сертификаты', desc: 'Все белые полотна сертифицированы: MSD, Bauf A+, Teqtum — гигиеническое заключение прилагается.' },
