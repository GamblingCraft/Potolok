  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Коричневые натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Коричневые натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Коричневый натяжной потолок — выбор ценителей природных материалов и тёплой атмосферы. Глубокий землистый тон создаёт ощущение надёжности, стабильности и природного уюта. Коричневый потолок органично вписывается в интерьеры с деревянными элементами и натуральным камнем.</p>
              <p>Особенно популярен в эко-стиле, кантри, тёплом минимализме и интерьерах под дерево. Доступен во всех фактурах — матовой, глянцевой и сатиновой.</p>

              <h3>Оттенки коричневого</h3>
              <p>Светло-коричневый (кофе с молоком), тёмный шоколад, орех, каштан, терракота, тёмная умбра. Замерщик привезёт образцы для подбора оттенка под ваш паркет или мебель.</p>

              <h3>Преимущества коричневых натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Коричневый потолок идеален для кабинетов, библиотек, ресторанов, баров, гостиных с деревянной мебелью и загородных домов. Создаёт уютную, тёплую атмосферу.</p>
            </div>
          </div>
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Замерщик приедет бесплатно, покажет образцы коричневых оттенков, рассчитает стоимость и оформит договор</p>
    ...
    <section class="cp-section cp-works" v-if="worksWithPrice.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Коричневые натяжные потолки — фото работ с ценами</h2>
          <p class="cp-section-desc">Примеры монтажа коричневых потолков в квартирах Иркутска с указанием площади и стоимости</p>
        </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость коричневого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Природное тепло</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии коричневых натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на коричневые потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Природный стиль</div>
          <h2 class="cp-h2 cp-h2--center">Коричневый потолок — природность и гарантия 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про коричневые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Коричневые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает коричневые натяжные потолки в Иркутске с 2009 года. Коричневый — природный тёплый цвет, который создаёт камерную уютную атмосферу и органично сочетается с деревянными элементами интерьера.</p>
            <h3>Виды коричневых натяжных потолков</h3>
            <p>Матовый коричневый — мягкий тёплый вид без бликов, хорошо сочетается с паркетом и деревянной мебелью. Глянцевый — зеркальный эффект с тёплым тёмным отблеском. Сатиновый — деликатный шёлковый блеск, универсален.</p>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите коричневый натяжной потолок?</h2>
...
const _content = await usePageContent('korichnevye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('korichnevye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('korichnevye-natyazhnye-potolki'))
...
const heroImg = usePageHero('korichnevye-natyazhnye-potolki', item.img)
...
const whyCards = [
  { icon: 'lucide:tree-pine', title: 'Природная эстетика', desc: 'Коричневые оттенки отсылают к натуральному дереву и природным материалам, создавая экологичную атмосферу.' },
