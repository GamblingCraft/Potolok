  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Цветные натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Цветные натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Цветной натяжной потолок — это возможность сделать помещение по-настоящему уникальным. Яркий акцентный потолок задаёт характер всему интерьеру: создаёт настроение, подчёркивает стиль и делает пространство запоминающимся.</p>
              <p>Мы работаем с полной RAL-палитрой — более 1000 оттенков. Любой цвет из каталога RAL доступен в матовой, глянцевой и сатиновой фактурах.</p>

              <h3>RAL-палитра — 1000+ оттенков</h3>
              <p>Выберите любой оттенок из каталога RAL Classic или RAL Design и мы изготовим потолок нужного цвета. Красный, синий, зелёный, фиолетовый, оранжевый — любой вариант под ваш интерьер.</p>

              <h3>Преимущества цветных натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Цветные потолки особенно популярны в детских комнатах, ресторанах, барах, студиях, торговых залах и шоу-румах. В жилых интерьерах — для создания яркого акцента в одном из помещений.</p>
            </div>
          </div>
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Замерщик приедет бесплатно, покажет цветные образцы из RAL-каталога, рассчитает стоимость и оформит договор</p>
            ...
            <div class="cp-aside-nav">
              <div class="cp-aside-nav__title">Другие цвета</div>
              <nav>
                <NuxtLink v-for="c in otherTsveta" :key="c.slug" :to="c.slug" class="cp-aside-nav__link" :class="{ active: c.id === item.id }">
                  <span class="cp-aside-nav__dot" :style="{ background: c.hex }"></span>{{ c.title }}
                </NuxtLink>
              </nav>
            </div>
          </aside>
    ...
    <section class="cp-section cp-works" v-if="worksWithPrice.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Цветные натяжные потолки — фото работ с ценами</h2>
          <p class="cp-section-desc">Примеры монтажа цветных потолков в квартирах и коммерческих объектах Иркутска</p>
        </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость цветного потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Более 1000 оттенков RAL</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии цветных натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на цветные потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Яркость без выцветания</div>
          <h2 class="cp-h2 cp-h2--center">Цветной потолок — насыщенность и гарантия 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про цветные натяжные потолки</h2>
        </div>
        <div class="cp-faq-list">
          <div
            class="cp-faq-item" v-for="(q, i) in faqItems" :key="q.q"
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Цветные натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает цветные натяжные потолки в Иркутске с 2009 года. Работаем с полной RAL-палитрой — более 1000 оттенков. Любой цвет — в матовой, глянцевой или сатиновой фактуре.</p>
            <h3>Где применяются цветные потолки</h3>
            <p>Детские комнаты, рестораны, кафе, бары, шоу-румы, спортивные залы, торговые центры. В квартирах — для создания яркого акцентного помещения или зонирования открытой планировки.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Замер бесплатный. Монтаж комнаты — 2–4 часа. Оплата после приёмки. Письменная гарантия 12 лет. Работаем ежедневно.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите цветной натяжной потолок?</h2>
          <p class="cp-cta__desc">Вызовите замерщика — приедет бесплатно, привезёт образцы RAL-каталога и рассчитает стоимость на месте</p>
        </div>
...
const _content = await usePageContent('cvetnye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('cvetnye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('cvetnye-natyazhnye-potolki'))
...
const heroImg = usePageHero('cvetnye-natyazhnye-potolki', item.img)
...
const otherTsveta = tsveta.map(c => ({ id: c.id, slug: c.slug, title: c.title, hex: c.hex }))
...
const whyCards = [
  { icon: 'lucide:palette', title: '1000+ оттенков RAL', desc: 'Работаем с полным каталогом RAL Classic и RAL Design — изготовим полотно любого цвета под заказ.' },
  ...
  { icon: 'lucide:sparkles', title: 'Цвет не выцветает', desc: 'Пигмент в структуре ПВХ-плёнки защищён от ультрафиолета — насыщенность цвета сохраняется на 25+ лет.' },
]
...
.cp-aside-nav__link { display: flex; align-items: center; gap: 8px; padding: 7px 0; font-size: 13px; font-weight: 500; color: var(--gray); text-decoration: none; border-bottom: 1px solid #f5f5f5; transition: color .15s; }
...
.cp-aside-nav__dot { width: 14px; height: 14px; border-radius: 50%; border: 1.5px solid #ddd; flex-shrink: 0; }
