  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Чёрные натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Чёрный натяжной потолок — смелый дизайнерский выбор для тех, кто хочет создать выразительный, атмосферный интерьер. Особенно эффектно смотрится с точечной подсветкой или LED-нишами, создавая иллюзию бесконечного пространства над головой.</p>
              <p>Чёрный цвет добавляет глубину и драму любому помещению. Матовая фактура даёт сдержанность и лаконичность лофта, глянцевая — эффект зеркала с бесконечным отражением огней.</p>
              <h3>Где используется</h3>
              <p>Гостиные в стиле лофт или хай-тек, домашние кинотеатры, кабинеты, рестораны и бары, ночные клубы. В жилых помещениях чёрный потолок часто комбинируют с белыми стенами или применяют как акцентный элемент в двухуровневой конструкции.</p>
              <h3>Преимущества чёрных натяжных потолков</h3>
              <ul class="cp-list">
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Замерщик приедет бесплатно, покажет образцы чёрных полотен, рассчитает стоимость и оформит договор</p>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость чёрного потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Матовый и глянцевый</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии чёрных натяжных потолков</h2>
          <p class="cp-section-desc">Реализованные проекты в Иркутске — нажмите на фото для просмотра</p>
        </div>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на чёрные потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Стиль и функциональность</div>
          <h2 class="cp-h2 cp-h2--center">Гарантия качества 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про чёрные натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Чёрные натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает чёрные натяжные потолки в Иркутске. Матовые, глянцевые, с подсветкой — от 169 ₽/м² с монтажом.</p>
            <h3>Чёрный матовый или глянцевый?</h3>
            <p>Матовый чёрный создаёт лаконичный лофт-эффект без бликов. Глянцевый чёрный — зеркало с отражением подсветки, эффектно в гостиных с точечными светильниками.</p>
            <h3>Монтаж в Иркутске</h3>
            <p>Замер бесплатный. Монтаж комнаты — 2–4 часа. Оплата после приёмки. Письменная гарантия 12 лет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите чёрный натяжной потолок?</h2>
...
const _content = await usePageContent('chernye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('chernye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('chernye-natyazhnye-potolki'))
...
const heroImg = usePageHero('chernye-natyazhnye-potolki', item.img)
...
const whyCards = [
  { icon: 'lucide:moon', title: 'Насыщенный чёрный цвет', desc: 'Цвет не выгорает и не тускнеет — стабилизаторы в составе ПВХ сохраняют интенсивность на 25–30 лет.' },
