  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Серые натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Серые натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Серый натяжной потолок — трендовый выбор для современного интерьера. Нейтральный и одновременно выразительный, он задаёт тон всему помещению, создавая атмосферу сдержанной элегантности. Особенно востребован в стилях лофт, минимализм и хай-тек.</p>
              <p>Доступен во всех фактурах: матовая — для офисов и спален, глянцевая — визуально расширяет пространство, сатиновая — деликатный блеск без бликов.</p>

              <h3>Оттенки серого</h3>
              <p>В нашем каталоге представлены оттенки от светлого жемчужно-серого до глубокого антрацита. Замерщик привезёт образцы — вы выберете нужный тон прямо у себя дома, не тратя время на поездки.</p>

              <h3>Преимущества серых натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Серый потолок органично вписывается в офисы, гостиные, кухни-студии и спальни. Прекрасно сочетается с деревом, металлом, бетоном и белыми стенами — создаёт современный сбалансированный интерьер.</p>
            </div>
          </div>
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Замерщик приедет бесплатно, покажет образцы серых оттенков, рассчитает стоимость и оформит договор</p>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость серого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">От светлого до антрацита</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии серых натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на серые потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Стиль и долговечность</div>
          <h2 class="cp-h2 cp-h2--center">Серый потолок — качество и гарантия 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про серые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Серые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает серые натяжные потолки в Иркутске с 2009 года. Серый — самый модный нейтральный цвет в современном дизайне интерьера: он подчёркивает фактуры, не конкурирует с мебелью и создаёт ощущение пространства.</p>
            <h3>Виды серых натяжных потолков</h3>
            <p>Матовые серые — идеальны для офисов, спален и минималистичных гостиных: рассеивают свет без бликов. Глянцевые — создают глубину и зеркальный эффект. Сатиновые — универсальный вариант с мягким шёлковым блеском.</p>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите серый натяжной потолок?</h2>
...
const _content = await usePageContent('serye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('serye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('serye-natyazhnye-potolki'))
const _prices = await useCatalogPrices()
const price = computed(() => _prices.value?.['base'] ?? item.price)

const item = tsveta.find(c => c.id === 'grey')!
const heroImg = usePageHero('serye-natyazhnye-potolki', item.img)
...
const whyCards = [
  { icon: 'lucide:layers', title: 'Богатая палитра серого', desc: 'Светло-серый, графитовый, антрацит, жемчужный — в каталоге более 20 оттенков серой гаммы.' },
