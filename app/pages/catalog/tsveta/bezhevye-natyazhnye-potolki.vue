  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Бежевые натяжные потолки в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Бежевые натяжные потолки — преимущества, фото</h2>
            <div class="cp-text" itemprop="description">
              <p>Бежевый натяжной потолок — воплощение домашнего уюта и природной гармонии. Тёплый нейтральный тон создаёт атмосферу комфорта и расслабленности, делая помещение по-настоящему жилым. Бежевый потолок прекрасно сочетается с натуральными материалами и деревянной мебелью.</p>
              <p>Доступен во всех фактурах: матовая — мягкий и бархатистый вид, сатиновая — деликатный блеск, глянцевая — визуально увеличивает пространство с тёплым отражением.</p>

              <h3>Оттенки бежевого</h3>
              <p>В нашем каталоге — кремовый, слоновая кость, карамельный, пшеничный, молочно-бежевый и тёплый капучино. Замерщик привезёт образцы — вы выберете нужный оттенок дома, с учётом вашего освещения и мебели.</p>

              <h3>Преимущества бежевых натяжных потолков</h3>
              <ul class="cp-list">
              ...
              <h3>Применение</h3>
              <p>Бежевый потолок идеально подходит для спален, гостиных, детских и кухонь. Особенно органичен в классическом, скандинавском, прованском интерьере и стиле эко.</p>
            </div>
          </div>
          ...
          <aside class="cp-aside">
            <div class="cp-aside-card">
              ...
              <p class="cp-aside-card__desc">Замерщик приедет бесплатно, покажет образцы бежевых оттенков, рассчитает стоимость и оформит договор</p>
    ...
    <section class="cp-section cp-works" v-if="worksWithPrice.length">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Бежевые натяжные потолки — фото работ с ценами</h2>
          <p class="cp-section-desc">Примеры монтажа бежевых потолков в квартирах Иркутска с указанием площади и стоимости</p>
        </div>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость бежевого потолка онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Тепло и уют</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии бежевых натяжных потолков</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на бежевые потолки</h2>
        </div>
    ...
    <section class="cp-section cp-why">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Натуральное тепло</div>
          <h2 class="cp-h2 cp-h2--center">Бежевый потолок — уют и гарантия 12 лет</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про бежевые натяжные потолки</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Бежевые натяжные потолки в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> устанавливает бежевые натяжные потолки в Иркутске с 2009 года. Бежевый — тёплый нейтральный цвет, который создаёт ощущение домашнего уюта и идеально дополняет натуральные материалы в интерьере.</p>
            <h3>Виды бежевых натяжных потолков</h3>
            <p>Матовые бежевые — мягкий бархатистый вид, идеальны для спален и гостиных. Сатиновые — шёлковый блеск с тёплым оттенком. Глянцевые — зеркальная поверхность с золотистым отливом.</p>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите бежевый натяжной потолок?</h2>
...
const _content = await usePageContent('bezhevye-natyazhnye-potolki')
...
const gallery = ref(await usePageGallery('bezhevye-natyazhnye-potolki'))
const portfolio = ref(await usePagePortfolio('bezhevye-natyazhnye-potolki'))
...
const heroImg = usePageHero('bezhevye-natyazhnye-potolki', item.img)
...
const whyCards = [
  { icon: 'lucide:sun', title: 'Тёплое свечение', desc: 'Бежевый потолок отражает свет с тёплым оттенком, создавая мягкую атмосферу без резкого белого бликования.' },
  ...
  { icon: 'lucide:home', title: 'Идеально для жилых комнат', desc: 'Бежевый потолок — лучший выбор для спален, гостиных и детских: создаёт ощущение дома и комфорта.' },
]
