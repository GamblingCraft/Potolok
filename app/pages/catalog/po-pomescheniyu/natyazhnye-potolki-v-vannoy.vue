  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в ванную — водонепроницаемые</h2>
            <div class="cp-text" itemprop="description">
              <p>Ванная — самое влажное помещение квартиры. ПВХ-натяжной потолок водонепроницаем на 100%: при затоплении от соседей удерживает до 100 литров воды на 1 м². Плесень не образуется — потолок не намокает.</p>
              <p>Глянцевое белое полотно — популярный выбор для ванной: визуально увеличивает небольшое пространство, легко моется. Двухуровневый или теневой потолок — стильное решение для просторных ванных.</p>
              <h3>Что мы предлагаем</h3>
              <p>Влагостойкие ПВХ-полотна, светильники IP44, глянцевые и матовые фактуры, теневой профиль для стильного минимализма.</p>
              <h3>Преимущества натяжных потолков в ванную</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка в ванную онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">100% водонепроницаемость</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в ванной</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки в ванную</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в ванную в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в ванную в Иркутске с 2009 года. 100% водонепроницаемые, монтаж без предоплаты, гарантия 12 лет.</p>
            <h3>Защита от затопления</h3>
            <p>ПВХ удерживает до 100 л/м². При затоплении звоните — мастер аккуратно сольёт воду и потолок примет прежнюю форму.</p>
            <h3>Глянец для маленькой ванной</h3>
            <p>Глянцевое полотно создаёт зеркальный эффект — визуально увеличивает небольшое пространство ванной комнаты.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите надёжный потолок в ванную?</h2>
...
const heroImg = usePageHero('natyazhnye-potolki-v-vannoy', item.img)
