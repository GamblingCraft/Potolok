  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки в прихожую в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в прихожую — первое впечатление</h2>
            <div class="cp-text" itemprop="description">
              <p>Прихожая встречает гостей первой — и натяжной потолок здесь задаёт тон всей квартире. Теневой профиль создаёт строгий минималистичный вид. Световые линии — современный архитектурный акцент. Глянцевое полотно визуально расширяет узкий коридор.</p>
              <p>Главная особенность прихожей — нестандартная форма с множеством углов. Натяжное полотно монтируется по любой конфигурации — без сложных стыков и швов.</p>
              <h3>Что мы предлагаем</h3>
              <p>Теневой профиль, трековые и точечные светильники, глянцевые и матовые полотна. Монтаж коридора за 2–3 часа.</p>
              <h3>Преимущества натяжных потолков в прихожую</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка в прихожую онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Первое впечатление о квартире</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в прихожей</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки в прихожую</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в прихожую в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в прихожую в Иркутске с 2009 года.</p>
            <h3>Особенности прихожей</h3>
            <p>Нестандартная геометрия, много углов — не проблема. Натяжное полотно крепится по периметру любой формы без швов.</p>
            <h3>Теневой профиль для прихожей</h3>
            <p>Теневой профиль создаёт чистую линию между потолком и стеной — популярное современное решение для минималистичного интерьера.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите стильную прихожую с натяжным потолком?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'hall')!
const gallery = catalogGallery['natyazhnye-potolki-v-prihozhey'] ?? []
...
useHead({
  title: 'Натяжные потолки в прихожую в Иркутске — от 159 ₽/м² | ПроПотолок',
  meta: [
    { name: 'description', content: 'Натяжные потолки в прихожую в Иркутске от 159 ₽/м². Парящий, теневой, световые линии. Монтаж за 1 день, гарантия 12 лет.' },
    { property: 'og:title', content: 'Натяжные потолки в прихожую в Иркутске | ПроПотолок' },
    { property: 'og:description', content: 'Натяжные потолки в прихожую от 159 ₽/м². Гарантия 12 лет, бесплатный замер.' },
    { property: 'og:image', content: item.img },
    { property: 'og:type', content: 'product' },
  ],
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Натяжные потолки в прихожую', description: 'Натяжные потолки в прихожую в Иркутске. Теневой, световые линии, глянцевые.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: item.price, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
