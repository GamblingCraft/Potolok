  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки в туалет в Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в туалет — быстро и надёжно</h2>
            <div class="cp-text" itemprop="description">
              <p>Туалет — небольшое помещение, но натяжной потолок здесь монтируется за 1–2 часа и служит десятилетиями. Влагостойкий ПВХ не боится пара и влажности. IP44 светильники — обязательны для помещений с повышенной влажностью.</p>
              <p>Белый глянцевый потолок визуально увеличивает маленький туалет. Матовый — классика без лишнего блеска. Для совмещённого санузла — те же решения что для ванной.</p>
              <h3>Что мы предлагаем</h3>
              <p>Влагостойкие ПВХ-полотна, IP44 светильники, глянцевые и матовые фактуры. Монтаж туалета за 1–2 часа.</p>
              <h3>Преимущества</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка в туалет онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Монтаж за 1–2 часа</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в туалете</h2>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в туалет в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в Иркутске с 2009 года.</p>
            <h3>Самый быстрый монтаж</h3>
            <p>Туалет до 5 м² монтируется за 1–2 часа. Оплата после монтажа, без предоплаты.</p>
            <h3>Глянец для маленького туалета</h3>
            <p>Глянцевое полотно создаёт зеркальный эффект — визуально увеличивает небольшой туалет.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите аккуратный потолок в туалете?</h2>
...
const gallery = catalogGallery['natyazhnye-potolki-v-tualete'] ?? []
