      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            ...
            <p>Туалет до 5 м² монтируется за 1–2 часа. Оплата после монтажа, оплата после приёмки.</p>
...
const _content = await usePageContent('natyazhnye-potolki-v-tualete')
...
const gallery = ref(await usePageGallery('natyazhnye-potolki-v-tualete'))
const portfolio = ref(await usePagePortfolio('natyazhnye-potolki-v-tualete'))
