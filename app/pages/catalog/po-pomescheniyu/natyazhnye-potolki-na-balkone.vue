  ...
  <div itemscope itemtype="https://schema.org/Product">
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки на балкон — утеплённый и холодный</h2>
            <div class="cp-text" itemprop="description">
              <p>Натяжные потолки на балкон — идеальное решение для застеклённых лоджий и балконов. ПВХ-полотно работает при температурах от -5 до +70°C, не боится перепадов и конденсата.</p>
              <p>Для открытого незастеклённого балкона рекомендуем влагостойкий ПВХ с IP44 светильниками. Монтаж занимает 1–2 часа — небольшая площадь.</p>
              <h3>Что мы предлагаем</h3>
              <p>Влагостойкие ПВХ-полотна для балконов и лоджий, IP44 светильники, монтаж за 1–2 часа.</p>
              <h3>Преимущества</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка на балкон онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Для застеклённых и открытых</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков на балконах</h2>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки на балкон в Иркутске — цены с установкой</h2>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите аккуратный потолок на балконе?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'balcony')!
const gallery = catalogGallery['natyazhnye-potolki-na-balkone'] ?? []
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Натяжные потолки на балкон в Иркутске от 159 ₽/м². Влагостойкие, работают при морозе. Монтаж за 1–2 часа. Гарантия 12 лет.' },
    { property: 'og:title', content: 'Натяжные потолки на балкон в Иркутске — от 159 ₽/м² | ПроПотолок' },
    { property: 'og:description', content: 'Натяжные потолки на балкон в Иркутске от 159 ₽/м². Влагостойкие, работают при морозе. Монтаж за 1–2 часа. Гарантия 12 лет.' },
    { property: 'og:image', content: item.img },
    { property: 'og:type', content: 'product' },
  ],
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Натяжные потолки на балкон — утеплённый и холодный', description: 'Натяжные потолки на балкон в Иркутске от 159 ₽/м². Влагостойкие, работают при морозе. Монтаж за 1–2 часа. Гарантия 12 лет.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: item.price, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
