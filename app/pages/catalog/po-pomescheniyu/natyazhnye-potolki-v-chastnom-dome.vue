  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки в частный дом в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в частный дом — без гвоздей в дерево</h2>
            <div class="cp-text" itemprop="description">
              <p>Натяжные потолки отлично монтируются в частных домах — кирпичных, деревянных, каркасных. В деревянном доме профиль крепится к стенам без гвоздей в деревянные конструкции — специальными кронштейнами, не повреждая несущие элементы.</p>
              <p>Особенность частного дома — высокие потолки, скошенные поверхности мансарды, нестандартная геометрия. Натяжное полотно справляется с любой конфигурацией — криволинейные профили, мансардные конструкции.</p>
              <h3>Что мы предлагаем</h3>
              <p>Специальные кронштейны для деревянных домов, мансардные конструкции, бесшовное полотно до 5 м шириной.</p>
              <h3>Преимущества натяжных потолков в частный дом</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолков в частный дом онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Деревянный дом — наш профиль</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в частных домах</h2>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки в частный дом</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в частный дом в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в частные дома в Иркутске с 2009 года.</p>
            <h3>Монтаж в деревянном доме</h3>
            <p>Специальные кронштейны позволяют крепить профиль без гвоздей в несущие деревянные конструкции.</p>
            <h3>Мансарда и нестандартная геометрия</h3>
            <p>Скошенные потолки мансарды — наша специализация. Криволинейные профили монтируются по любой геометрии.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите красивые потолки в частный дом?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'house')!
const gallery = catalogGallery['natyazhnye-potolki-v-chastnom-dome'] ?? []
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Натяжные потолки в частный дом в Иркутске от 159 ₽/м². Деревянный и кирпичный дом. Мансарда. Монтаж без гвоздей в дерево. Гарантия 12 лет.' },
    { property: 'og:title', content: 'Натяжные потолки в частный дом в Иркутске | ПроПотолок' },
    { property: 'og:description', content: 'Натяжные потолки в частный дом от 159 ₽/м². Деревянный дом, мансарда, гарантия 12 лет.' },
    { property: 'og:image', content: item.img },
    { property: 'og:type', content: 'product' },
  ],
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Натяжные потолки в частный дом', description: 'Натяжные потолки в частный дом в Иркутске. Деревянный, кирпичный дом, мансарда.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: item.price, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
