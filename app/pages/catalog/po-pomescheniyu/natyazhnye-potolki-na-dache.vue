...
const _content = await usePageContent('natyazhnye-potolki-na-dache')
...
const gallery = ref(await usePageGallery('natyazhnye-potolki-na-dache'))
const portfolio = ref(await usePagePortfolio('natyazhnye-potolki-na-dache'))
