  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки на кухню в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки на кухню — влагостойкие и практичные</h2>
            <div class="cp-text" itemprop="description">
              <p>Кухня — особое помещение с повышенной влажностью, перепадами температур и риском затопления. Натяжные потолки из ПВХ — идеальный выбор: водонепроницаемы, удерживают до 100 л/м² при затоплении от соседей.</p>
              <p>Матовое белое полотно — самый популярный выбор для кухни. Глянцевое — визуально увеличивает. Для зонирования кухни-гостиной — световые линии или двухуровневый потолок.</p>
              <h3>Что мы предлагаем</h3>
              <p>Влагостойкие ПВХ-полотна, светильники IP44 с защитой от влаги, световые линии для зонирования студии, глянцевые и матовые фактуры. Монтаж кухни до 15 м² за 2–3 часа.</p>
              <h3>Преимущества натяжных потолков на кухню</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка на кухню онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Влагостойкость и практичность</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков на кухне</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на потолки на кухню</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки на кухню</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки на кухню в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки на кухню в Иркутске с 2009 года. Влагостойкие ПВХ-полотна, монтаж без предоплаты, гарантия 12 лет.</p>
            <h3>Защита от затопления</h3>
            <p>ПВХ-полотно удерживает до 100 литров на 1 м² при затоплении от соседей. Позвоните нам — мастер приедет и аккуратно сольёт воду без повреждения потолка.</p>
            <h3>Зонирование кухни-гостиной</h3>
            <p>Световые линии или двухуровневый потолок визуально разделят кухню и гостиную в студии без строительных работ.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите практичный потолок на кухню?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'kitchen')!
const gallery = catalogGallery['natyazhnye-potolki-na-kuhne'] ?? []
...
useHead({
  ...
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Натяжные потолки на кухню', description: 'Влагостойкие натяжные потолки на кухню в Иркутске.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: item.price, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
