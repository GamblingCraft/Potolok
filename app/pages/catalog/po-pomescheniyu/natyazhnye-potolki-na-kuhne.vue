...
const _content = await usePageContent('natyazhnye-potolki-na-kuhne')
...
const gallery = ref(await usePageGallery('natyazhnye-potolki-na-kuhne'))
const portfolio = ref(await usePagePortfolio('natyazhnye-potolki-na-kuhne'))
...
const heroImg = usePageHero('natyazhnye-potolki-na-kuhne', item.img)
