  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Натяжные потолки в гостиную в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          ...
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в гостиную — красота и функциональность</h2>
            <div class="cp-text" itemprop="description">
              <p>Гостиная — главное помещение квартиры, и потолок здесь играет ключевую роль. Для гостиных особенно популярны парящие потолки со скрытой LED-подсветкой, двухуровневые конструкции для зонирования и световые линии SLOTT.</p>
              <p>Матовое белое полотно — классика для гостиной. Глянцевое — визуально увеличивает пространство. Тканевое — создаёт уютную атмосферу. Подберём оптимальный вариант под ваш интерьер и бюджет.</p>

              <h3>Что мы предлагаем</h3>
              <p>Парящие потолки с LED-нишей, двухуровневые конструкции, световые линии SLOTT/FLEXY, точечные светильники и трековые системы. Матовые, глянцевые, сатиновые фактуры.</p>

              <h3>Преимущества натяжных потолков в гостиную</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка в гостиную онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Гостиная — главная комната</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в гостиной</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на потолки в гостиную</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки в гостиную</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в гостиную в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в гостиную в Иркутске с 2009 года. Работаем с европейскими материалами, монтируем без предоплаты, даём письменную гарантию 12 лет.</p>
            <h3>Популярные решения для гостиной</h3>
            <p>Парящий потолок со скрытой LED-нишей — самое популярное решение для зала. Световые линии SLOTT создают современный архитектурный акцент. Двухуровневый потолок зонирует пространство без стен.</p>
            <h3>Монтаж потолка в гостиной в 2026 году</h3>
            <p>Стандартный зал до 25 м² монтируется за 3–5 часов. Двухуровневый или с парящей нишей — за 1 рабочий день. Без пыли и строительного мусора.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите красивый потолок в гостиную?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'living')!
const gallery = catalogGallery['natyazhnye-potolki-v-gostinoy'] ?? []
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Натяжные потолки в гостиную в Иркутске от 159 ₽/м². Парящие, двухуровневые, со световыми линиями. Монтаж за 1 день, гарантия 12 лет.' },
    { property: 'og:title', content: 'Натяжные потолки в гостиную в Иркутске | ПроПотолок' },
    { property: 'og:description', content: 'Натяжные потолки в гостиную от 159 ₽/м². Монтаж за 1 день, гарантия 12 лет, бесплатный замер.' },
  ...
  script: [
    {
      ...
      innerHTML: JSON.stringify({
        ...
        '@type': 'Product',
        name: 'Натяжные потолки в гостиную',
        description: 'Натяжные потолки в гостиную в Иркутске. Парящие, двухуровневые, световые линии.',
