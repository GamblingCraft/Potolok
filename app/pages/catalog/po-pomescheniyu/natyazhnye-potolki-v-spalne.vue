...
const _content = await usePageContent('natyazhnye-potolki-v-spalne')
...
const gallery = ref(await usePageGallery('natyazhnye-potolki-v-spalne'))
const portfolio = ref(await usePagePortfolio('natyazhnye-potolki-v-spalne'))
