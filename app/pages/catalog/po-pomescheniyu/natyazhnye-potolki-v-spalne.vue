  ...
  <div itemscope itemtype="https://schema.org/Product">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">
            Натяжные потолки в спальню в&nbsp;Иркутске
          </h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в спальню — уют и спокойствие</h2>
            <div class="cp-text" itemprop="description">
              <p>Для спальни важен комфортный рассеянный свет и спокойная атмосфера. Идеальный выбор — матовое или сатиновое белое полотно. Тёплая LED-подсветка 2700К в парящей нише над кроватью создаёт уютное освещение для отдыха.</p>
              <p>Тканевые гипоаллергенные потолки особенно рекомендуются для спальни — без ПВХ, без токсинов, дышат. Звёздное небо — романтика и уникальность. Важно: планируйте освещение заранее — потом не переделать.</p>

              <h3>Что мы предлагаем</h3>
              <p>Матовые и сатиновые полотна, тканевые Clipso/Descor без ПВХ, парящий с LED 2700К, звёздное небо, точечные споты и диммер.</p>

              <h3>Преимущества натяжных потолков в спальню</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка в спальню онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Комфорт и здоровый сон</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в спальне</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на потолки в спальню</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки в спальню</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в спальню в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в спальню в Иркутске с 2009 года. Работаем с европейскими материалами, монтируем без предоплаты, даём письменную гарантию 12 лет.</p>
            <h3>Лучшие решения для спальни</h3>
            <p>Матовое или сатиновое полотно — классика для спальни. Тканевый Clipso — для аллергиков. Парящая ниша с LED 2700К над изголовьем кровати — идеальный ночной свет.</p>
            <h3>Звёздное небо в спальне</h3>
            <p>150–300 оптоволоконных нитей создают эффект звёздного неба. Абсолютно безопасно — не нагревается и не проводит ток.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите уютный потолок в спальню?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'bedroom')!
const gallery = catalogGallery['natyazhnye-potolki-v-spalne'] ?? []
...
useHead({
  title: 'Натяжные потолки в спальню в Иркутске — от 159 ₽/м² | ПроПотолок',
  meta: [
    { name: 'description', content: 'Натяжные потолки в спальню в Иркутске от 159 ₽/м². Матовые, сатиновые, тканевые. Парящий с LED 2700К. Монтаж за 1 день, гарантия 12 лет.' },
    { property: 'og:title', content: 'Натяжные потолки в спальню в Иркутске | ПроПотолок' },
    { property: 'og:description', content: 'Натяжные потолки в спальню от 159 ₽/м². Монтаж за 1 день, гарантия 12 лет, бесплатный замер.' },
  ...
  script: [{
    ...
    innerHTML: JSON.stringify({
      ...
      description: 'Натяжные потолки в спальню в Иркутске. Матовые, тканевые, парящие с LED.',
      brand: { '@type': 'Brand', name: 'ПроПотолок' },
      offers: { '@type': 'Offer', price: item.price, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } },
    }),
  }],
})
