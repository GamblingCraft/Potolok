  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки в офис в Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в офис — корпоративный стиль</h2>
            <div class="cp-text" itemprop="description">
              <p>Для офиса важны правильное освещение, акустика и корпоративный стиль. Световые линии SLOTT создают современный архитектурный вид. Трековые системы дают гибкость в расположении светильников. Акустические тканевые потолки Clipso поглощают эхо.</p>
              <p>Монтируем в офисах без остановки работы — одна зона за раз. Большие площади без шва до 5 м шириной. Негорючие полотна Teqtum обязательны для коммерческих объектов по нормам пожарной безопасности.</p>
              <h3>Что мы предлагаем</h3>
              <p>Световые линии SLOTT, трековые системы, акустические Clipso, негорючие Teqtum. Поэтапный монтаж без остановки работы.</p>
              <h3>Преимущества</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка в офис онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Монтаж без остановки работы</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в офисах</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в офис в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в Иркутске с 2009 года.</p>
            <h3>Световые линии и трековые системы</h3>
            <p>SLOTT создаёт архитектурный свет встроенный прямо в полотно. Трековые — максимальная гибкость в расположении светильников.</p>
            <h3>Пожарная безопасность</h3>
            <p>Негорючие полотна Teqtum сертифицированы для коммерческих объектов и соответствуют всем требованиям МЧС.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите современный потолок в офис?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'office')!
const gallery = catalogGallery['natyazhnye-potolki-v-ofise'] ?? []
...
useHead({
  title: 'Натяжные потолки в офис в Иркутске — от 159 ₽/м² | ПроПотолок',
  meta: [
    { name: 'description', content: 'Натяжные потолки в офис в Иркутске от 159 ₽/м². Световые линии, трековые системы, акустические. Монтаж без остановки работы. Гарантия 12 лет.' },
    { property: 'og:title', content: 'Натяжные потолки в офис в Иркутске — от 159 ₽/м² | ПроПотолок' },
    { property: 'og:description', content: 'Натяжные потолки в офис в Иркутске от 159 ₽/м². Световые линии, трековые системы, акустические. Монтаж без остановки работы. Гарантия 12 лет.' },
    { property: 'og:image', content: item.img },
    { property: 'og:type', content: 'product' },
  ],
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Натяжные потолки в офис — корпоративный стиль', description: 'Натяжные потолки в офис в Иркутске от 159 ₽/м². Световые линии, трековые системы, акустические. Монтаж без остановки работы. Гарантия 12 лет.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: item.price, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
