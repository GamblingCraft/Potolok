  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки в квартиру в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в квартиру — вся квартира за 1 день</h2>
            <div class="cp-text" itemprop="description">
              <p>Натяжные потолки — самый быстрый способ обновить квартиру. Вся 2–3-комнатная квартира монтируется за 1 рабочий день. Не нужно освобождать жильё, нет пыли и строительного мусора, нет запаха.</p>
              <p>Для каждой комнаты подберём свою фактуру: матовый в спальне и детской, парящий с подсветкой в гостиной, глянцевый на кухне и в ванной. Оптимизируем бюджет — при заказе от 3 помещений 3-й потолок в подарок.</p>
              <h3>Что мы предлагаем</h3>
              <p>Разные фактуры в каждой комнате, парящий в гостиной, влагостойкий в ванной. Единый договор на всю квартиру.</p>
              <h3>Преимущества натяжных потолков в квартиру</h3>
              <ul class="cp-list">
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолков в квартиру онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Вся квартира за 1 день</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в квартирах</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на потолки в квартиру</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки в квартиру</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в квартиру в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в квартиры в Иркутске с 2009 года.</p>
            <h3>Вся квартира за 1 день</h3>
            <p>2–3-комнатная квартира монтируется за 1 рабочий день. Без пыли, без строительного мусора, без запаха.</p>
            <h3>Акция 3-й потолок в подарок</h3>
            <p>При одновременном заказе от 3 помещений — наименьшее монтируем бесплатно. Выгодно обновить сразу всю квартиру.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите обновить всю квартиру за 1 день?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'flat')!
const gallery = catalogGallery['natyazhnye-potolki-v-kvartire'] ?? []
