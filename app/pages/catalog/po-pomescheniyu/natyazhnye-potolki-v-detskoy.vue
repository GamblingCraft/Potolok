  ...
  <div itemscope itemtype="https://schema.org/Product">
    <section class="cp-hero">
      ...
      <div class="container cp-hero__inner">
        <div class="cp-hero__content">
          ...
          <h1 class="cp-hero__title" itemprop="name">Натяжные потолки в детскую в&nbsp;Иркутске</h1>
    ...
    <section class="cp-section cp-about">
      <div class="container">
        <div class="cp-two-col">
          <div class="cp-main">
            <h2 class="cp-h2">Натяжные потолки в детскую — безопасные и яркие</h2>
            <div class="cp-text" itemprop="description">
              <p>Для детской комнаты главное — безопасность материалов. Тканевые полотна Clipso и Descor без ПВХ и токсичных пластификаторов — сертифицированы для детских учреждений. Матовые белые с маркировкой A+ (Bauf) также безопасны.</p>
              <p>Звёздное небо — мечта каждого ребёнка: 150–300 мерцающих оптоволокон прямо на потолке. Фотопечать с облаками, лесом, героями мультфильмов. RGB-подсветка с пультом управления — ребёнок сам меняет цвет.</p>
              <h3>Что мы предлагаем</h3>
              <p>Тканевые Clipso/Descor без ПВХ, звёздное небо (150–300 оптоволокон), фотопечать, RGB-подсветка с пультом. Холодный монтаж без запаха.</p>
              <h3>Преимущества натяжных потолков в детскую</h3>
              <ul class="cp-list">
          ...
          <aside class="cp-aside">
            ...
            <div class="cp-aside-nav">
              <div class="cp-aside-nav__title">Другие помещения</div>
              <nav>
                <NuxtLink v-for="p in otherPomeshcheniya" :key="p.slug" :to="p.slug" class="cp-aside-nav__link" :class="{ active: p.id === item.id }">
                  <Icon name="lucide:arrow-right" size="13"/>{{ p.title }}
                </NuxtLink>
              </nav>
            </div>
          </aside>
    ...
    <section class="cp-calc-cta">
      <div class="container cp-calc-cta__inner">
        ...
        <div>
          <div class="cp-calc-cta__title">Рассчитайте стоимость потолка в детскую онлайн</div>
    ...
    <section class="cp-section cp-gallery" v-if="gallery.length">
      <div class="container">
        <div class="cp-section-head">
          <div class="cp-pretitle cp-pretitle--dark">Безопасность и детская радость</div>
          <h2 class="cp-h2 cp-h2--center">Фотографии потолков в детской</h2>
    ...
    <section class="cp-section cp-promo">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Акции и скидки на потолки в детскую</h2>
        </div>
    ...
    <section class="cp-section cp-faq" itemscope itemtype="https://schema.org/FAQPage">
      <div class="container">
        <div class="cp-section-head">
          ...
          <h2 class="cp-h2 cp-h2--center">Частые вопросы про натяжные потолки в детскую</h2>
        </div>
      ...
      <div class="container">
        <div class="cp-seo-inner">
          <div class="cp-seo-content">
            <h2>Натяжные потолки в детскую в Иркутске — цены с установкой</h2>
            <p>Компания <strong>ПроПотолок</strong> реализует и устанавливает натяжные потолки в детскую в Иркутске с 2009 года. Безопасные материалы, звёздное небо, фотопечать — монтаж без предоплаты, гарантия 12 лет.</p>
            <h3>Безопасные материалы для детской</h3>
            <p>Clipso и Descor без ПВХ сертифицированы для детских садов и школ. Матовый ПВХ с маркировкой A+ (Bauf) — безопасен для жилых помещений.</p>
            <h3>Звёздное небо — самый популярный запрос</h3>
            <p>Оптоволокно не нагревается и не проводит ток — абсолютно безопасно. 150–300 мерцающих звёзд создают сказочную атмосферу в детской комнате.</p>
          </div>
    ...
    <section class="cp-cta">
      <div class="container cp-cta__inner">
        <div>
          <h2 class="cp-cta__title">Хотите красивый и безопасный потолок в детскую?</h2>
...
const item = pomeshcheniya.find(p => p.id === 'kids')!
const gallery = catalogGallery['natyazhnye-potolki-v-detskoy'] ?? []
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Натяжные потолки в детскую в Иркутске от 159 ₽/м². Тканевые без ПВХ, гипоаллергенные. Звёздное небо, фотопечать. Монтаж за 1 день, гарантия 12 лет.' },
    { property: 'og:title', content: 'Натяжные потолки в детскую в Иркутске | ПроПотолок' },
    { property: 'og:description', content: 'Натяжные потолки в детскую от 159 ₽/м². Безопасные, звёздное небо, гарантия 12 лет.' },
    { property: 'og:image', content: item.img },
    { property: 'og:type', content: 'product' },
  ],
  script: [{ type: 'application/ld+json', innerHTML: JSON.stringify({ '@context': 'https://schema.org', '@type': 'Product', name: 'Натяжные потолки в детскую', description: 'Безопасные натяжные потолки в детскую в Иркутске. Тканевые без ПВХ, звёздное небо, фотопечать.', brand: { '@type': 'Brand', name: 'ПроПотолок' }, offers: { '@type': 'Offer', price: item.price, priceCurrency: 'RUB', availability: 'https://schema.org/InStock', seller: { '@type': 'LocalBusiness', name: 'ПроПотолок', address: { '@type': 'PostalAddress', addressLocality: 'Иркутск', addressCountry: 'RU' } } } }) }],
})
