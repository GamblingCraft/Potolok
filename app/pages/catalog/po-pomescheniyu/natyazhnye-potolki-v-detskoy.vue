...
const _content = await usePageContent('natyazhnye-potolki-v-detskoy')
...
const gallery = ref(await usePageGallery('natyazhnye-potolki-v-detskoy'))
const portfolio = ref(await usePagePortfolio('natyazhnye-potolki-v-detskoy'))
