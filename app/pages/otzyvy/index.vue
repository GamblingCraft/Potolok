    ...
    <section class="rv-seo">
      <div class="container rv-seo__inner">
        <div class="rv-seo__content">
          ...
          <p>Средний рейтинг по всем платформам — <strong>{{ avgRating }} из 5</strong>. Клиенты отмечают качество полотен, аккуратность мастеров, соблюдение сроков и прозрачность ценообразования. Цена фиксируется в договоре до начала работ — никаких доплат после монтажа.</p>
        ...
        <div class="rv-seo__aside">
          <div class="rv-seo__aside-card">
            <div class="rv-seo__aside-rating">{{ avgRating }}</div>
