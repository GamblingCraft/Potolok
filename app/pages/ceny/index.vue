...
const faqs = [
  ...
  { q: 'Когда нужно платить?', a: 'Мы оплата после приёмки. Оплата производится только после завершения монтажа и вашей приёмки работы. Принимаем наличные и банковские карты.' },
