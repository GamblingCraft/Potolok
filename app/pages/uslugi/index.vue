      ...
      <div class="container">
        <div class="sv-seo__inner">
          <div class="sv-seo__content">
            ...
            <p>Монтаж выполняют сертифицированные мастера с опытом от 5 лет. Установка потолка в стандартной комнате занимает 2–4 часа. Оплата после приёмки — оплата после приёмки работы. Монтаж входит в стоимость полотна.</p>
