  ...
  <div>
    ...
    <section class="gp-hero">
      ...
      <div class="container gp-hero__inner">
        <div class="gp-hero__content">
          ...
          <h1 class="gp-hero__title">Правобережный округ</h1>
          <p class="gp-hero__price"><strong>от 159 ₽/м²</strong> — замер и выезд бесплатно</p>
          <p class="gp-hero__desc">
            Монтируем натяжные потолки в Правобережном округе — историческом центре Иркутска. Работаем на Ленина, Карла Маркса, Горького, набережных Ангары и во всех предместьях. Один день — готово.
          </p>
          <div class="gp-facts">
    ...
    <section class="gp-section gp-about">
      <div class="container gp-two-col">
        <div class="gp-two-col__text">
          <div class="gp-pretitle gp-pretitle--dark">Исторический центр Иркутска</div>
          <h2 class="gp-title">Работаем в Правобережном округе — историческом центре города</h2>
          <p class="gp-body">Правобережный округ — это исторический центр Иркутска. Здесь расположены предместья Марата, Рабочее и Радищево, микрорайон Иркутск-Сити, районы Зелёный, Лесной и Топкинский. По центральным улицам — Ленина, Карла Маркса, Горького, Тимирязева, Сухэ-Батора, Чкалова и набережным Ангары — сосредоточена основная историческая застройка города.</p>
          <p class="gp-body">Здесь соседствуют дореволюционные купеческие дома и деревянные особняки XIX века, сталинки с высокими лепными потолками 3+ метра, советские многоэтажки и современные жилые комплексы. Для каждого типа дома знаем правильный технический подход.</p>
          <p class="gp-body"><strong>Выезд замерщика бесплатный.</strong> Никаких надбавок «за центр» — цены единые для всего Иркутска.</p>
        ...
        <div class="gp-two-col__aside">
          <div class="gp-aside-card">
            <div class="gp-aside-card__title">Цены в Правобережном округе</div>
    ...
    <section class="gp-section gp-prices">
      <div class="container">
        <div class="gp-head">
          ...
          <h2 class="gp-title">Стоимость натяжных потолков в Правобережном округе</h2>
    ...
    <section class="gp-section gp-reviews">
      <div class="container">
        <div class="gp-head">
          ...
          <h2 class="gp-title">Что говорят жители Правобережного округа</h2>
        </div>
    ...
    <section class="gp-cta">
      <div class="container gp-cta__inner">
        <div>
          <h2 class="gp-cta__title">Готовы заказать потолок?</h2>
          <p class="gp-cta__desc">Выезд замерщика бесплатно — в любой день, в удобное для вас время</p>
        </div>
    ...
    <section class="gp-section gp-faq">
      <div class="container">
        <div class="gp-head">
          ...
          <h2 class="gp-title">Часто спрашивают жители Правобережного округа</h2>
        </div>
      ...
      <div class="container">
        <div class="gp-seo-inner">
          <div class="gp-seo-content">
            <h2>Натяжные потолки в Правобережном округе Иркутска</h2>
            <p>Правобережный округ — это исторический центр Иркутска с улицами Ленина, Карла Маркса, Горького, Тимирязева, Сухэ-Батора, Чкалова, Дзержинского, Рабочей, Баррикад, Марата, Свердлова, Октябрьской Революции, набережными Ангары. Округ включает предместья Марата, Рабочее и Радищево, микрорайон Иркутск-Сити, районы Зелёный, Лесной, Топкинский, Славный.</p>
            <p>Архитектура здесь самая разнообразная: дореволюционные деревянные особняки, сталинки с потолками 3+ метров, советские панельки и современные ЖК. В сталинских домах мы точно рассчитываем натяжение полотна с учётом высоты. В старом фонде скрываем трещины, неровности и следы протечек — результат за один день.</p>
            <h3>Монтаж без выноса мебели</h3>
            <p>Работаем методом холодного натяжения — без тепловых пушек. Мебель накрываем защитной плёнкой, уборку делаем после монтажа. Никакого запаха и грязи.</p>
            <h3>Гарантия и документы</h3>
            <p>На каждый объект — официальный договор, акт выполненных работ, гарантийный талон на 12 лет. Работаем с физическими и юридическими лицами.</p>
          </div>
          <div class="gp-seo-links">
            <div class="gp-seo-links__title">Улицы Правобережного округа</div>
            <nav>
              <span class="gp-seo-street">ул. Ленина</span>
              <span class="gp-seo-street">ул. Карла Маркса</span>
              <span class="gp-seo-street">ул. Горького</span>
              <span class="gp-seo-street">ул. Тимирязева</span>
              <span class="gp-seo-street">ул. Сухэ-Батора</span>
              <span class="gp-seo-street">ул. Чкалова</span>
              <span class="gp-seo-street">ул. Баррикад</span>
              <span class="gp-seo-street">ул. Марата</span>
            </nav>
...
const utpItems = [
  { icon: 'lucide:landmark', title: 'Опыт в исторических домах', desc: 'Сталинки с потолками 3+ м, дореволюционные постройки, хрущёвки' },
...
const reviews = [
  { author: 'Елена Соколова', date: '20 апреля 2025', text: 'Живём в сталинке на Тимирязева — потолки 3,2 метра, была лепнина и трещины. Мастера справились отлично, парящий потолок с подсветкой смотрится шикарно. Цена точно по договору, никаких доплат.', rating: 5, platform: '2ГИС' },
  { author: 'Игорь Пономарёв', date: '5 марта 2025', text: 'Квартира на Карла Маркса, старый фонд. Потолок был с неровностями и желтизной. Заказали матовый — после монтажа идеальная плоскость, все дефекты скрыты. Работали быстро и чисто.', rating: 5, platform: 'Яндекс' },
  { author: 'Татьяна Морозова', date: '14 января 2025', text: 'Заказывала потолки в предместье Марата. Замерщик приехал в день звонка, объяснил всё без лишних слов. Сделали матовый белый в двух комнатах за один день. Очень довольна!', rating: 5, platform: 'Avito' },
]

const faqs = [
  { q: 'Работаете ли вы в новостройках Правобережного округа?', a: 'Да, активно работаем в новых жилых кварталах. Делаем потолки как в квартирах с черновой отделкой, так и в готовых. Согласовываем порядок работ с другими строителями при необходимости.' },
  { q: 'Есть ли доплата за выезд в Правобережный округ?', a: 'Никакой доплаты. Цены единые для всего Иркутска. Замер и выезд мастеров бесплатны.' },
  { q: 'Нужно ли освобождать комнату перед монтажом?', a: 'Нет. Работаем методом холодного натяжения — без тепловых пушек. Мебель накрываем защитной плёнкой и снимаем после работы. Без запаха и грязи.' },
  { q: 'Сколько времени займёт монтаж в двухкомнатной квартире?', a: '4–6 часов. Приедем утром — к вечеру готово. Если квартира большая или заказана сложная конструкция, предупредим заранее о сроках.' },
  { q: 'Делаете ли скидки при заказе нескольких комнат?', a: 'Да. При заказе от 10 м² — скидка 7%, от 30 м² — 10%, от 50 м² — 15%, свыше 70 м² — 20%. Скидка применяется автоматически и фиксируется в договоре.' },
  { q: 'Как произвести оплату после монтажа?', a: 'Принимаем наличные, банковские карты и безналичный перевод. Предоплата не требуется — платите только после приёмки готовой работы.' },
]
</script>
