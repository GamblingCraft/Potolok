...
export const faqCategories: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Нужна ли предоплата?', a: 'Нет. Мы оплата после приёмки. Оплата производится только после завершения монтажа и вашей приёмки работы. Принимаем наличные, банковские карты и безналичный перевод.' },
