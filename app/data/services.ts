...
export const services: Service[] = [
  {
    ...
    shortTitle: 'Монтаж',
    description: 'Профессиональный монтаж натяжного потолка любой сложности. Работаем с матовыми, глянцевыми, сатиновыми и тканевыми полотнами. Монтаж за 1 день, оплата після приёмки.',
