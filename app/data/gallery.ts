...
export const catalogGallery: Record<string, GalleryItem[]> = {
  ...
  'negoryuchie-natyazhnye-potolki': [
    ...
    { id: 3, img: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80', title: 'Негорючий Descor в гостинице', area: 25, room: 'Гостиница', price: 12500, details: ['Descor Trevira CS', 'Углы: 4 шт', 'Профиль: 26 м', 'Споты: 12 шт'] },
