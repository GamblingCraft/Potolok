  ...
  'matovye-natyazhnye-potolki': [
    {
      id: 1,
      img: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800&q=80',
      title: 'Матовый потолок в зале',
      area: 20,
      room: 'Гостиная',
      price: 7180,
      details: ['Углы: 6 шт', 'Профиль: 22 м', 'Светильники: 7 шт', 'Цвет: белый'],
    },
    {
      id: 2,
      img: 'https://images.unsplash.com/photo-1616046229478-9901c5536a45?w=800&q=80',
      title: 'Матовый в спальне',
      area: 15,
      room: 'Спальня',
      price: 5420,
      details: ['Углы: 4 шт', 'Профиль: 16 м', 'Споты: 5 шт', 'Цвет: белый'],
    },
  ],
  ...
  'satinovye-natyazhnye-potolki': [
    {
      id: 1,
      img: 'https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80',
      title: 'Сатиновый в гостиной',
      area: 18,
      room: 'Гостиная',
      price: 9630,
      details: ['Углы: 10 шт', 'Профиль: 22 м', 'Светильники: 3 шт', 'Цвет: чёрный'],
    },
  ],
