...
export const priceVidy: PriceItem[] = [
  ...
  { id: 12, catalogKey: 'beton',           name: 'Потолок «под бетон»',   description: 'Фотопечать 1200 dpi — реалистичная текстура промышленного бетона. Лофт-стиль.', priceFrom: 550, priceTo: 900,  unit: 'м²', badge: 'Новинка', popular: false },
